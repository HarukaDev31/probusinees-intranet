...
class PedidosAgente extends CI_Controller {
        ...
        foreach ($arrData as $row) {
			...
			$dropdown_estado = '<div class="dropdown">';
				...
				$dropdown_estado .= '<ul class="dropdown-menu">';
					...
					$dropdown_estado .= '<li class="dropdown-item p-0"><a class="px-3 py-1 btn-block" alt="Confirmado" title="Confirmado" href="javascript:void(0)" onclick="cambiarEstado(\'' . $row->ID_Pedido_Cabecera . '\',2);">Garantizado</a></li>';
				$dropdown_estado .= '</ul>';
			$dropdown_estado .= '</div>';
	...
	public function downloadImage($id){
		...
		array_debug($objPedido->Txt_Url_Imagen_Producto);
