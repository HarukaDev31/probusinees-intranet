...
class SliderTiendaVirtualController extends CI_Controller {
	...
	function __construct(){
		...
		$this->load->model('TiendaVirtual/Configuracion/SliderModel');
	...
	public function listar(){
		...
		if(isset($this->session->userdata['usuario'])) {
			...
			$this->load->view('TiendaVirtual/Configuracion/SliderView');
			$this->load->view('footer', array("js_slider_tienda_virtual" => true));
		}
	}
