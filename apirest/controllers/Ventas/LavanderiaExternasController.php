...
class LavanderiaExternasController extends CI_Controller {
	
	function __construct(){
    	parent::__construct();	
		$this->load->library('session');
		$this->load->database('LAE_SYSTEMS');
		$this->load->model('Ventas/LavanderiaExternasModel');
	...
	public function listar(){
		...
		if(isset($this->session->userdata['usuario'])) {
			...
			$this->load->view('Ventas/LavanderiaExternasView');
			$this->load->view('footer', array("js_lavanderia_externas" => true));
		}
    }
    ...
    private function getReporte($arrParams){
        $arrResponseModal = $this->LavanderiaExternasModel->getReporte($arrParams);
	...
	public function sendReportePDF($Fe_Inicio, $Fe_Fin, $iIdTipoDocumento, $iIdSerieDocumento, $iNumeroDocumento, $iEstado, $iIdCliente, $sNombreCliente){
		...
		ob_start();
		$file = $this->load->view('Ventas/pdf/LavanderiaExternasViewPDF', array(
