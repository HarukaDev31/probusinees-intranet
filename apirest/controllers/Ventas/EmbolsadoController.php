...
class EmbolsadoController extends CI_Controller {
	
	function __construct(){
    	parent::__construct();	
		$this->load->library('session');
		$this->load->database('LAE_SYSTEMS');
		$this->load->model('Ventas/EmbolsadoModel');
	...
	public function listar(){
		...
		if(isset($this->session->userdata['usuario'])) {
			...
			$this->load->view('Ventas/EmbolsadoView');
			$this->load->view('footer', array("js_embolsado" => true));
		}
	}
	...
	public function agregarPedido(){
        ...
        echo json_encode($this->EmbolsadoModel->agregarPedido($this->input->post()));
	}

	public function actualizarPedido(){
        if (!$this->input->is_ajax_request()) exit('No se puede eliminar y acceder');
        echo json_encode($this->EmbolsadoModel->actualizarPedido($this->input->post()));
	}
	...
	public function cambiarEstadoLavado(){
		...
		if ( !isset($_POST['arrIdDocumentoCabecera']) ){
			...
			echo json_encode($this->EmbolsadoModel->cambiarEstadoLavado($this->input->post()));
			exit();
        }
	}
	
    private function getReporte($arrParams){
        $arrResponseModal = $this->EmbolsadoModel->getReporte($arrParams);
	...
	public function sendReportePDF($Fe_Inicio, $Fe_Fin, $iIdTipoDocumento, $iIdSerieDocumento, $iNumeroDocumento, $iEstado, $iEstadoLavado, $iIdFamilia, $iIdItem, $sNombreItem, $iIdCliente, $sNombreCliente){
		...
		ob_start();
		$file = $this->load->view('Ventas/pdf/EmbolsadoViewPDF', array(
