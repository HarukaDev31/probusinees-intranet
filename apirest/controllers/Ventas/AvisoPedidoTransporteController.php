...
class AvisoPedidoTransporteController extends CI_Controller {
	
	function __construct(){
    	parent::__construct();	
		$this->load->library('session');
		$this->load->database('LAE_SYSTEMS');
		$this->load->model('Ventas/AvisoPedidoTransporteModel');
	...
	public function listar(){
		...
		if(isset($this->session->userdata['usuario'])) {
			...
			$this->load->view('Ventas/AvisoPedidoTransporteView');
			$this->load->view('footer', array("js_aviso_pedido_transporte" => true));
		}
	}
	...
	public function agregarPedido(){
        ...
        echo json_encode($this->AvisoPedidoTransporteModel->agregarPedido($this->input->post()));
	}

	public function actualizarPedido(){
        if (!$this->input->is_ajax_request()) exit('No se puede eliminar y acceder');
        echo json_encode($this->AvisoPedidoTransporteModel->actualizarPedido($this->input->post()));
	}
	
    private function getReporte($arrParams){
        $arrResponseModal = $this->AvisoPedidoTransporteModel->getReporte($arrParams);
	...
	public function sendReportePDF($Fe_Inicio, $Fe_Fin, $iIdTipoDocumento, $iIdSerieDocumento, $iNumeroDocumento, $iEstado, $iIdCliente, $sNombreCliente){
		...
		ob_start();
		$file = $this->load->view('Ventas/pdf/AvisoPedidoTransporteViewPDF', array(
