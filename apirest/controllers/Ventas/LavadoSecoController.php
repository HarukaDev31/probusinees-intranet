...
class LavadoSecoController extends CI_Controller {
	
	function __construct(){
    	parent::__construct();	
		$this->load->library('session');
		$this->load->database('LAE_SYSTEMS');
		$this->load->model('Ventas/LavadoSecoModel');
	...
	public function listar(){
		...
		if(isset($this->session->userdata['usuario'])) {
			...
			$this->load->view('Ventas/LavadoSecoView');
			$this->load->view('footer', array("js_lavado_seco" => true));
		}
	}
	...
	public function actualizarPedido(){
        ...
        echo json_encode($this->LavadoSecoModel->actualizarPedido($this->input->post()));
	}
	...
	public function cambiarEstadoLavado(){
		...
		if ( !isset($_POST['arrIdDocumentoCabecera']) ){
			...
			echo json_encode($this->LavadoSecoModel->cambiarEstadoLavado($this->input->post()));
			exit();
        }
    }
    
    private function getReporte($arrParams){
        $arrResponseModal = $this->LavadoSecoModel->getReporte($arrParams);
        if ( $arrResponseModal['sStatus']=='success' ) {
            ...
            foreach ($arrResponseModal['arrData'] as $row) {
                ...
                $rows['ID_Documento_Estado_Lavado'] = $row->ID_Documento_Estado_Lavado;
	...
	public function sendReportePDF($Fe_Inicio, $Fe_Fin, $iIdTipoDocumento, $iIdSerieDocumento, $iNumeroDocumento, $iEstado, $iEstadoLavado, $iIdFamilia, $iIdItem, $sNombreItem, $iIdCliente, $sNombreCliente){
		...
		ob_start();
		$file = $this->load->view('Ventas/pdf/LavadoSecoViewPDF', array(
