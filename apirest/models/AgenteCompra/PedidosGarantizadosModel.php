...
class PedidosGarantizadosModel extends CI_Model
{
    ...
    public function getItemProveedor($ID)
    {
        ...
        $this->db->join($this->table . ' AS ACPC', 'ACPC.ID_Pedido_Detalle = ACPDPP.ID_Pedido_Detalle', 'join');
        $this->db->join($this->table_suppliers . ' AS S', 'S.id_supplier = ACPDPP.ID_Entidad_Proveedor', 'jpin');
