<?php
class EmbolsadoModel extends CI_Model{
    ...
    public function getReporte($arrParams){
        ...
        //AND VC.Nu_Estado_Lavado IN(8,9,17)
        if ( $iEstadoLavado == "0" ) {
            $cond_estado_orden_lavado = "AND (VD.Nu_Estado_Lavado IN(8,9,17,18) OR DDEL.Nu_Estado_Lavado IN(8,9,17,18))";
        } else if ( $iEstadoLavado == "16" ) {
            $cond_estado_orden_lavado = "AND (VD.Nu_Estado_Lavado IN(8,9,17) OR DDEL.Nu_Estado_Lavado IN(8,9,17))";
        } else if ( $iEstadoLavado == "18" ) {
            $cond_estado_orden_lavado = "AND (VD.Nu_Estado_Lavado IN(18) OR DDEL.Nu_Estado_Lavado IN(18))";
        }
...
AND ITEM.ID_Tipo_Pedido_Lavado IN(1,4,5)
...
ORDER BY VC.ID_Documento_Cabecera DESC;";
	...
	public function actualizarPedido($arrPost){
        ...
        $data = array( 'ID_Entidad_Lavado_Embolsado' => $arrPost['arrCabecera']['iIdEntidad'], 'ID_Entidad_Lavado' => $arrPost['arrCabecera']['iIdEntidad'], 'Txt_Embolsado' => $arrPost['arrCabecera']['sFinalEmbolsado'], 'Nu_Estado_Lavado' => $iEstadoLavado );
	...
	public function cambiarEstadoLavado($arrPost){
        ...
        $this->db->update_batch('documento_detalle_estado_lavado', $arrCambiarEstadoDocumentoDetalle, 'ID_Documento_Detalle');
