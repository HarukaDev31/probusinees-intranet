<?php
class VentasXUsuariosModel extends CI_Model{
    ...
    public function getReporte($arrParams){
      ...
      $cond_empleado = ( $iIdEmpleado != '-' && $sNombreEmpleado != '-' ) ? 'AND VC.ID_Mesero = ' . $iIdEmpleado : "AND VC.ID_Mesero !='' ";
...
USR.ID_Usuario,
'' AS Nu_Documento_Identidad,
USR.No_Nombres_Apellidos AS No_Entidad,
USR.No_Usuario,
