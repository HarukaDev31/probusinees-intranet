<?php
class DobladoModel extends CI_Model{
    ...
    public function getReporte($arrParams){
        ...
        //AND VC.Nu_Estado_Lavado = 7
        if ( $iEstadoLavado == "0" ) {
            $cond_estado_orden_lavado = "AND (VD.Nu_Estado_Lavado IN(8,9) OR DDEL.Nu_Estado_Lavado IN(8,9))";
            ...
            $cond_estado_orden_lavado = "AND (VD.Nu_Estado_Lavado IN(9) OR DDEL.Nu_Estado_Lavado IN(9))";
        }
...
ORDER BY VC.ID_Documento_Cabecera DESC;";
	...
	public function actualizarPedido($arrPost){
        ...
        $data = array( 'ID_Entidad_Lavado_Doblado' => $arrPost['arrCabecera']['iIdEntidad'], 'ID_Entidad_Lavado' => $arrPost['arrCabecera']['iIdEntidad'], 'Txt_Doblado' => $arrPost['arrCabecera']['sFinalDoblado'], 'Nu_Estado_Lavado' => $iEstadoLavado );
