...
ORDER BY ID_Almacen ASC, ID_Producto ASC, Fe_Emision ASC";
        ...
        */
//echo count($arrIdAlmacenyIdProducto);
//echo "-----------";
        for ($i = 0; $i < count($arrIdAlmacenyIdProducto); $i++) {
            //echo $i;
            //echo "=======\n<br>";
            ...
            */
            ...
            if(isset($arrIdAlmacenyIdProducto[$rowAlmacen])) {
                for ($x = 0; $x < count($arrIdAlmacenyIdProducto[$rowAlmacen]); $x++) {
                    $sCadenaIdProductosSaldoInicial .= $arrIdAlmacenyIdProducto[$rowAlmacen][$x] . ",";
                }
            }
            ...
            /*
            echo "<pre>";
            var_dump($sCadenaIdProductosSaldoInicial);
            echo "</pre>";
            */
...
AND ALMA.ID_Almacen = " . $rowAlmacen  .  "
" . $where_variante_item . "
" . $where_variante_item_detalle_1 . "
" . $where_variante_item2 . "
" . $where_variante_item_detalle_2 . "
...
" . $where_variante_item_detalle_3 . " " . $where_like_nombre_item . " " . $where_producto_sin_stock . " ORDER BY ALMA.ID_Almacen ASC, PRO.ID_Producto ASC";
            ...
            $arrResponseSQL = $this->db->query($query_stock_producto);
        ...
        $dataNew=array();
        $arrStockAlmacenProductoSinMovimiento=array();
        for ($x = 0; $x < count($arrDataAlmacenSinMovimiento); $x++) {
            foreach($arrDataAlmacenSinMovimiento[$x] as $row_new){
                /*
                echo "<pre>";
                var_dump($row_new);
                echo "</pre>";
                */
                $rows=array();
                $arrStockAlmacenProductoSinMovimiento[] = $row_new;
            }
            
            //$dataNew[] = $arrDataAlmacenSinMovimiento[$x];
            //$dataNew[] = array_merge($arrDataAlmacenSinMovimiento[$x]);
        }
        
        /*
        echo "<pre>";
        var_dump($arrStockAlmacenProductoSinMovimiento);
        echo "</pre>";
        */
        

        if ( count($arrData) > 0 && count($arrStockAlmacenProductoSinMovimiento) > 0){
            return array(
                'sStatus' => 'success',
                'arrData' => $arrData,
                'arrDataAlmacenSinMovimiento' => $arrStockAlmacenProductoSinMovimiento
            );
        }
