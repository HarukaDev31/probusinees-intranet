...
class ProductoModel extends CI_Model{
	...
	public function _get_datatables_query(){
		...
		if ( $this->input->post('Filtro_Nu_Estado') != '-' )
        	$this->db->like('PRO.Nu_Activar_Item_Lae_Shop', $this->input->post('Filtro_Nu_Estado'));

		$this->db->select('PRO.ID_Empresa, PRO.ID_Producto, Nu_Codigo_Barra, No_Producto, 0 AS Qt_Producto, PRO.Ss_Precio_Ecommerce_Online_Regular, PRO.Ss_Precio_Ecommerce_Online, No_Imagen_Item, PRO.Nu_Version_Imagen, F.No_Familia, PRO.No_Imagen_Item, PRO.Nu_Version_Imagen, PRO.Nu_Activar_Item_Lae_Shop AS Nu_Estado, Nu_Destacado_Item_Lae_Shop')
    ...
    public function count_all(){
        if( !empty($this->input->post('Global_Filter')) && $this->input->post('Filtros_Productos') == 'Producto' ){
        	...
        	$this->db->like('Nu_Codigo_Barra', $this->input->post('Global_Filter'));
        } else if ( !empty($this->input->post('Global_Filter')) && $this->input->post('Filtros_Productos') == 'CodigoSKU' ){
