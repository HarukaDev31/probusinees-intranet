<?php
class BilleteraModel extends CI_Model{
    ...
    public function _get_datatables_query(){
        ...
        $this->db->select('ID_Cuenta_Bancaria_Billetera, No_Empresa, No_Banco_Siglas, Nu_Tipo_Cuenta, No_Moneda, No_Cuenta_Bancaria, No_Cuenta_Interbancario, No_Titular_Cuenta, ' . $this->table . '.Nu_Estado')
        ->from($this->table)
