          ...
          <div class="box-header box-header-new">
            <div class="row div-Filtros">
              ...
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-2">
                ...
                <div class="form-group">
        				  <select id="cbo-filtro_estado_producto" class="form-control">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-7 div-productos">
                <div class="form-group">
            ...
            <div class="row div-Filtros">
              <div class="col-xs-12 col-sm-6 col-md-3 hidden">
                ...
                <div class="form-group">
        				  <label style="font-weight:normal"><input type="radio" id="radio-fe_actual" name="radio-fecha" value="0" class="flat-red" onclick="verFecha(this.value);" checked>&nbsp; Stock Actual</label>
        				  &nbsp;&nbsp;<label style="font-weight:normal"><input type="radio" id="radio-fe_seleccionada" name="radio-fecha" value="1" class="flat-red" onclick="verFecha(this.value);">&nbsp; Por Fecha</label>
                </div>
              </div>
              
              <div class="col-xs-6 col-sm-3 col-md-2 div-fecha_stock_valorizado hidden">
                <div class="form-group">
              ...
              <div class="col-xs-12 col-sm-12 col-md-5 hidden">
                ...
                <div class="form-group">
                  <label style="font-weight:normal"><input type="radio" id="radio-stock_todos" class="flat-red" name="radio-stock" value="3" checked>&nbsp; Todos</label>
        				  &nbsp;&nbsp;<label style="font-weight:normal"><input type="radio" id="radio-stock_no" class="flat-red" name="radio-stock" value="0">&nbsp; Mayor a Cero</label>
        				  &nbsp;&nbsp;<label style="font-weight:normal"><input type="radio" id="radio-stock_negativo" class="flat-red" name="radio-stock" value="2">&nbsp; En cero</label>
        				  &nbsp;&nbsp;<label style="font-weight:normal"><input type="radio" id="radio-stock_si" class="flat-red" name="radio-stock" value="1">&nbsp; Negativo</label>
                </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 hidden">
                ...
                <div class="form-group">
                  <label style="font-weight:normal"><input type="radio" id="radio-agrupar_x_categoria_si" class="flat-red" name="radio-agrupar_x_categoria" value="1" checked>&nbsp; Si</label>
        				  &nbsp;&nbsp;<label style="font-weight:normal"><input type="radio" id="radio-agrupar_x_categoria_no" class="flat-red" name="radio-agrupar_x_categoria" value="0">&nbsp; No</label>
                </div>
              </div>
            </div>
