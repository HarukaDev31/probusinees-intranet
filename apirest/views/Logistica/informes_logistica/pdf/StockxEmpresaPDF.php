      ...
      <table class="table_pdf">
        <thead>
          ...
          <tr class="tr-theadFormatTitle">
            <th align="center" colspan="2">Stock Valorizado x Empresa</th>
          </tr>
          <tr class="tr-theadFormat">
      ...
      <br/>
        ...
        <thead>
          <tr class="tr-thead tr-theadFormat">
            ...
            <?php if (($this->empresa->ID_Empresa==73 && $arrCabecera['iActionEditar'] == 1) || $this->empresa->ID_Empresa!=73) : ?>
            ...
            foreach($arrDetalle as $row) {
              if ($ID_Familia != $row->ID_Familia) {
                ...
                <tr class="tr-theadFormat tr-theadFormat_header">
                  ...
                  <th class="text-left" colspan="7"><?php echo $row->No_Categoría; ?></th>
                </tr>
                <?php
