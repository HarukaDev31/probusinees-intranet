      ...
      <table class="table_pdf">
        <thead>
          ...
          <tr class="tr-theadFormatTitle">
            <th align="center" colspan="2">Informe de Compras por Proveedor</th>
          </tr>
          <tr class="tr-theadFormat">
      ...
      <br/>
        ...
        <thead>
          <tr class="tr-thead tr-theadFormat">
            ...
            <th class="text-center" rowspan="2">Nro. Lote</th>
            <th class="text-center" rowspan="2">F. Vcto.</th>
            <th class="text-center" rowspan="2">Percepción</th>
        ...
        <tbody>
          ...
          if ( $arrDetalle['sStatus'] == 'success' ) {
            ...
            foreach($arrDetalle['arrData'] as $row) {
              if ($ID_Entidad != $row->ID_Entidad || $ID_Almacen != $row->ID_Almacen) {
                if ($counter != 0) { ?>
                  <tr class="tr-theadFormat tr-theadFormat_footer">
                    ...
                    <th class="text-right"><?php echo numberFormat($sum_compra_cantidad, 3, '.', ','); ?></th>
                    <th class="text-right">&nbsp;</th>
                    <th class="text-right"><?php echo numberFormat($sum_compra_subtotal_s, 2, '.', ','); ?></th>
                    <th class="text-right"><?php echo numberFormat($sum_compra_igv_s, 2, '.', ','); ?></th>
                    <th class="text-right"><?php echo numberFormat($sum_compra_descuento_s, 2, '.', ','); ?></th>
                    <th class="text-right"><?php echo numberFormat($sum_compra_total_s, 2, '.', ','); ?></th>
                    <th class="text-right"><?php echo numberFormat($sum_compra_total_d, 2, '.', ','); ?></th>
                ...
                if ($ID_Almacen != $row->ID_Almacen) {
                  if ($counter_almacen != 0) { ?>
                    <tr class="tr-theadFormat tr-theadFormat_footer">
                      ...
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compra_cantidad, 3, '.', ','); ?></th>
                      <th class="text-right">&nbsp;</th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compra_subtotal_s, 2, '.', ','); ?></th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compra_igv_s, 2, '.', ','); ?></th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compra_descuento_s, 2, '.', ','); ?></th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compra_total_s, 2, '.', ','); ?></th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compra_total_d, 2, '.', ','); ?></th>
                      <th class="text-right" colspan="3">&nbsp;</th>
                    </tr>
                    <?php
                ...
                <tr class="tr-theadFormat tr-theadFormat_header">
                  ...
                  <th class="text-left" colspan="14"><?php echo $row->No_Entidad; ?></th>
                </tr>
                <?php
              ...
              if ($arrCabecera['iTipoReporte'] == 0) {?>
                <tr class="tr-theadFormat">
                  ...
                  <td class="text-right"><?php echo numberFormat($row->Ss_Precio, 3, '.', ','); ?></td>
                  ...
                  <td class="text-right"><?php echo $row->Nu_Lote_Vencimiento; ?></td>
                  <td class="text-right"><?php echo $row->Fe_Lote_Vencimiento; ?></td>
                  <td class="text-right"><?php echo numberFormat($row->Ss_Percepcion, 2, '.', ','); ?></td>
                  <td class="text-right"><?php echo $row->No_Estado; ?></td>
                </tr>
                <?php
              }
            ...
            <tr class="tr-theadFormat tr-theadFormat_footer">
              ...
              <th class="text-right"><?php echo numberFormat($sum_general_compra_cantidad, 3, '.', ','); ?></th>
              <th class="text-right">&nbsp;</th>
              <th class="text-right"><?php echo numberFormat($sum_general_compra_subtotal_s, 2, '.', ','); ?></th>
              <th class="text-right"><?php echo numberFormat($sum_general_compra_igv_s, 2, '.', ','); ?></th>
              <th class="text-right"><?php echo numberFormat($sum_general_compra_descuento_s, 2, '.', ','); ?></th>
              <th class="text-right"><?php echo numberFormat($sum_general_compra_total_s, 2, '.', ','); ?></th>
              <th class="text-right"><?php echo numberFormat($sum_general_compra_total_d, 2, '.', ','); ?></th>
              <th class="text-right" colspan="3">&nbsp;</th>
            </tr>
          <?php
          } else { ?>
