          ...
          <div class="box-header box-header-new">
            <div class="row div-Filtros">
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  <label>Almacén</label>
    		  				<select id="cbo-Almacenes_Saldo_x_Proveedor" class="form-control select2" style="width: 100%;"></select>
            ...
            <div class="row div-Filtros">
              ...
              <div class="col-xs-4 col-md-4">
                <div class="form-group">
                  <button type="button" id="btn-html_saldo_proveedor" class="btn btn-default btn-block btn-saldo_proveedor" data-type="html"><i class="fa fa-search"></i> Buscar</button>
                </div>
              </div>
              
              <div class="col-xs-4 col-md-4">
                <div class="form-group">
                  <button type="button" id="btn-pdf_saldo_proveedor" class="btn btn-default btn-block btn-saldo_proveedor" data-type="pdf"><i class="fa fa-file-pdf-o color_icon_pdf"></i> PDF</button>
                </div>
              </div>
              
              <div class="col-xs-4 col-md-4">
                <div class="form-group">
                  <button type="button" id="btn-excel_saldo_proveedor" class="btn btn-default btn-block btn-saldo_proveedor" data-type="excel"><i class="fa fa-file-excel-o color_icon_excel"></i> Excel</button>
                </div>
              </div>
            </div>
          </div>
          <!-- /.box-header -->
          <div id="div-saldo_proveedor" class="table-responsive">
            <table id="table-saldo_proveedor" class="table table-striped table-bordered">
              <thead>
                <tr>
