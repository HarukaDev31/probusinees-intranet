            ...
            <div class="row div-Filtros">
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  <label>Almacén</label>
    		  				<select id="cbo-Almacenes_ReporteFormaPagoProveedor" class="form-control select2" style="width: 100%;"></select>
              ...
              <div class="col-xs-4 col-sm-4 col-md-2">
                <label>Serie</label>
                <div class="form-group">
                  <input type="text" id="cbo-filtros_series_documento" class="form-control input-Mayuscula input-codigo_barra" maxlength="20" placeholder="Ingresar serie" value="" autocomplete="off">
                </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-5 col-md-4 hidden">
                <div class="form-group">
                  <label>Personal</label>
                  <input type="hidden" id="txt-AID_Personal" class="form-control">
                  <input type="text" id="txt-Filtro_Personal" class="form-control autocompletar_personal" data-global-class_method="AutocompleteController/getAllEmployee" data-global-table="entidad" placeholder="Ingresar Nombre / Nro. Documento de Identidad" value="" autocomplete="off">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
            </div>
