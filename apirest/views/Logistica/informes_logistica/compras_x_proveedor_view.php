          ...
          <div class="box-header box-header-new">
            <div class="row div-Filtros">
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  <label>Almacén</label>
    		  				<select id="cbo-Almacenes_Compras_x_Proveedor" class="form-control select2" style="width: 100%;"></select>
              ...
              <div class="col-xs-12 col-sm-6 col-md-5">
                <div class="form-group">
                  ...
                  <input type="text" id="txt-No_Producto" class="form-control autocompletar_detalle" data-global-class_method="AutocompleteController/globalAutocomplete" data-global-table="producto" placeholder="Buscar por nombre / código de barra / código sku" value="" autocomplete="off">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
            ...
            <div class="row div-Filtros">
              ...
              <div class="col-xs-4 col-md-4">
                <div class="form-group">
                  <button type="button" id="btn-html_compras_x_proveedor" class="btn btn-primary btn-block btn-generar_compras_x_proveedor" data-type="html"><i class="fa fa-search"></i> Buscar</button>
                </div>
              </div>
              
              <div class="col-xs-4 col-md-4">
                <div class="form-group">
                  <button type="button" id="btn-pdf_compras_x_proveedor" class="btn btn-danger btn-block btn-generar_compras_x_proveedor" data-type="pdf"><i class="fa fa-file-pdf-o"></i> PDF</button>
                </div>
              </div>
              
              <div class="col-xs-4 col-md-4">
                <div class="form-group">
                  <button type="button" id="btn-excel_compras_x_proveedor" class="btn btn-success btn-block btn-generar_compras_x_proveedor" data-type="excel"><i class="fa fa-file-excel-o"></i> Excel</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <table id="table-compras_x_proveedor" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th class="text-center" rowspan="2">F. Vencimiento</th>
