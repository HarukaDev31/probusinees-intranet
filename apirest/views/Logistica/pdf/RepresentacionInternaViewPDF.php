...
<html>
    ...
    <body>
      ...
      $arrParamsBuscarGuiaFactura = array('ID_Guia_Cabecera' => $arrData[0]->ID_Guia_Cabecera);
      ...
      <br/>
        ...
        <thead>
          ...
          <tr class="tr-sub_thead">
            ...
            <th class="text-left content" style="width: 67%;"><?php echo $arrData[0]->Txt_Direccion_Origen . ' ' . $Valor_Ubigeo_Inei_Partida; ?></th>
          </tr>
          <tr class="tr-sub_thead">
            <th class="text-left title" style="width: 33%;"><b>PUNTO DE LLEGADA:</b></th>
            <th class="text-left content" style="width: 67%;"><?php echo $arrData[0]->Txt_Direccion_Destino . ' ' . $Valor_Ubigeo_Inei_Llegada; ?></th>
          </tr>
        </thead>
      </table>
      <br/>
      ...
      <br/>
      <br/>
      <?php if(!empty($sTipoDocumentoRelacionVenta) && !empty($sSerieDocumentoRelacionVenta) && !empty($sNumeroDocumentoRelacionVenta)) { ?>
	  	<table class="table_pdf" border="0">
        <thead>
          <tr class="tr-theadFormat tr-header tr-header-detalle">
            <th class="text-left title" style="width: 100%;"><b>DOCUMENTOS RELACIONADOS</b></th>
          </tr>
          <tr class="tr-sub_thead">
            <th class="text-left content" colspan="2" style="width: 100%;"><?php echo $sTipoDocumentoRelacionVenta . ': ' . $sSerieDocumentoRelacionVenta . ' - ' . $sNumeroDocumentoRelacionVenta; ?></th>
          </tr>
        </thead>
      </table>
      <br/>
