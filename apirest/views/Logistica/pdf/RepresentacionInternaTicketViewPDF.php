      ...
      ?>
        ...
        <thead>
          <tr class="tr-sub_thead">
            <th class="text-center title"><?php echo $No_Empresa = (substr($arrData[0]->Nu_Documento_Identidad_Empresa,0,2) == '20' ? $arrData[0]->No_Empresa : $arrData[0]->No_Empresa_Comercial );?></th>
          </tr>
          <tr class="tr-sub_thead">
            <td class="text-center title"><?php echo $arrData[0]->Txt_Direccion_Empresa;?></td>
          </tr>
          <?php if ($arrData[0]->Txt_Direccion_Empresa != $arrData[0]->Txt_Direccion_Almacen) { ?>
          <tr class="tr-sub_thead">
            <td class="text-center title"><?php echo $arrData[0]->Txt_Direccion_Almacen;?></td>
          </tr>
          <?php } ?>
          <tr class="tr-sub_thead">
            <td class="text-center title"><?php echo (!empty($this->empresa->Nu_Celular_Empresa) ? $this->empresa->Nu_Celular_Empresa : '') . ' ' . (!empty($this->empresa->Nu_Telefono_Empresa) ? $this->empresa->Nu_Telefono_Empresa : '');?></td>
          </tr>
          <tr class="tr-sub_thead">
            <td class="text-center title"><?php echo (!empty($this->empresa->Txt_Email_Empresa) ? $this->empresa->Txt_Email_Empresa : '');?></td>
          </tr>
          <tr class="tr-sub_thead">
            <td class="text-center title">&nbsp;</td>
          </tr>
          <tr class="tr-sub_thead">
            <th class="text-center title"><?php echo 'RUC: ' . $arrData[0]->Nu_Documento_Identidad_Empresa;?></th>
          </tr>
          <tr class="tr-sub_thead">
            <th class="text-center title"><?php echo $sTipoDocumento;?></th>
          </tr>
          <tr class="tr-sub_thead">
            <th class="text-center title"><?php echo $arrData[0]->ID_Serie_Documento . '-' . $arrData[0]->ID_Numero_Documento;?></th>
          </tr>
        </thead>
      </table>
	  	<table class="table_pdf" border="0">
      ...
      <br/>
        ...
        <thead>
          <tr class="tr-theadFormat tr-header tr-header-detalle">
            ...
            <th class="text-center" style="width: 15%">UM</th>
        ...
        <tbody>
          ...
          ?>
            <tr class="<?php echo $sNameClassTrDetalle; ?>">
              ...
              <td class="text-left" style="width: 50%"><?php echo $row->No_Producto . $row->Txt_Nota_Item . $sVarianteMultiple; ?></td>
              <td class="text-center" style="width: 15%"><?php echo $row->Nu_Sunat_Codigo_UM; ?></td>
              <td class="text-right" style="width: 20%"><?php echo number_format($row->Qt_Producto, 3, '.', ','); ?></td>
            </tr>
            <?php
            $iCounter++;
          } ?>
        ...
        <thead>
          <tr class="tr-theadFormat tr-totales">
            <th class="text-right standar title_bold" style="width: 80%">TOTAL</th>
            <th class="text-right standar title_bold" style="width: 20%"><?php echo numberFormat($fTotalCantidad, 3, '.', ','); ?></th>
          </tr>
        </thead>
      </table>
      <br/><br/>
        ...
        <thead>
          <?php if (isset($arrData['GLOSA']) && !empty($arrData['GLOSA'])) { ?>
          <tr class="tr-importe_letras">
            <th class="text-left" colspan="3"><b>OBSERVACIONES:</b> <?php echo nl2br($arrData['GLOSA']); ?></th>
          </tr>
          <?php } ?>
        </thead>
      </table>
      <?php if(substr($arrData[0]->ID_Serie_Documento, 0, 1) == 'T') { ?>
        ...
        <thead>
          <tr class="tr-sub_thead"><br>
            <th class="text-left content" style="width: 80%;">Representación impresa de la <?php echo strtoupper($arrData[0]->No_Tipo_Documento); ?> ELECTRÓNICA, <b>visita https://laesystems.com</b></th>
          </tr>
        </thead>
      </table>
      <?php } ?>
      <?php if ( substr($arrData[0]->ID_Serie_Documento, 0, 1) == 'T' && $arrHeaderBDCredenciales->Nu_Estado_Sistema == 0 ) { ?>
