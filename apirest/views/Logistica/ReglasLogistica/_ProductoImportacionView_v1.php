        ...
        <div class="box box-content">
          ...
          <div class="box-body div-AgregarEditar" style="padding:0px">
            ...
            ?>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-2">
                    ...
                    <a class="btn btn-link" target="_blank" style="padding:0px; color: #7b7b7b" href="<?php echo base_url() . 'Logistica/ReglasLogistica/UnidadMedidaController/listarUnidadesMedida'; ?>">[Crear]</a>
                    <div class="form-group">
                      <select id="cbo-UnidadesMedida_Precio" name="ID_Unidad_Medida_Precio" class="form-control select2" style="width: 100%;"></select>
                      <span class="help-block" id="error"></span>
                    </div>
                  </div>
              ...
              <div class="row hidden"><!-- ./productos variantes -->
                <div class="col-xs-12">
              ...
              <div class="row hidden"><!-- ./productos relacionados -->
                <div class="col-xs-12">
