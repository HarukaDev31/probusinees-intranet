...
<div class="content-wrapper">  
      ...
      <div class="col-xs-12">
        <div class="box box-content">
            ...
            <div class="row div-Filtros">
              ...
              <div class="col-md-3">
                <div class="form-group">
    		  				<select id="cbo-Filtros_Lineas" name="Filtros_Lineas" class="form-control">
    		  				  <option value="Linea">Nombre Sub Categoría</option>
              ...
              <div class="col-md-3">
                ...
                <button type="button" class="btn btn-success btn-block" onclick="agregarLinea()"><i class="fa fa-plus-circle"></i> Agregar</button>
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table id="table-Linea" class="table table-striped table-bordered">
              <thead>
                <tr>
                  <th>Categoria</th>
                  <th>Sub Categoria</th>
  ...
  <!-- /.content -->
  <?php
  $attributes = array('id' => 'form-Linea');
  echo form_open('', $attributes);
  ?>
  <!-- Modal -->
  <div class="modal fade" id="modal-Linea" role="dialog">
  <div class="modal-dialog">
      ...
      <div class="modal-header">
    	...
    	<div class="modal-body">
    	  ...
    	  <input type="hidden" name="EID_Familia" class="form-control required">
    	  <input type="hidden" name="EID_Sub_Familia" class="form-control required">
    	  <input type="hidden" name="ENo_Sub_Familia" class="form-control required">
          ...
          <div class="col-sm-5 col-md-5">
            ...
            <div class="form-group">
              <input type="text" id="txt-No_Sub_Familia" name="No_Sub_Familia" placeholder="Ingresar Nombre" class="form-control required" maxlength="100" autocomplete="off">
              <span class="help-block" id="error"></span>
            </div>
          </div>
