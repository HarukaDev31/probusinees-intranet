...
<div class="content-wrapper">  
      ...
      <div class="col-xs-12">
        <div class="box box-content">
            ...
            <div class="row div-Filtros">
              ...
              <div class="col-md-3">
                <div class="form-group">
    		  				<select id="cbo-Filtros_Laboratorios" name="Filtros_Laboratorios" class="form-control">
    		  				  <option value="Laboratorio">Nombre Laboratorio</option>
    		  				</select>
                </div>
              </div>
              ...
              <div class="col-md-3">
                ...
                <button type="button" class="btn btn-success btn-block" onclick="agregarLaboratorio()"><i class="fa fa-plus-circle"></i> Agregar</button>
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table id="table-Laboratorio" class="table table-striped table-bordered">
              <thead>
                <tr>
                  <th>Nombre</th>
  ...
  <!-- /.content -->
  <form id="form-Laboratorio" enctype="multipart/form-data" method="post" role="form" autocomplete="off">
  <!-- Modal -->
  <div class="modal fade" id="modal-Laboratorio" role="dialog">
  <div class="modal-dialog">
      ...
      <div class="modal-header">
        ...
        <input type="hidden" name="EID_Empresa" class="form-control">
    	  <input type="hidden" name="EID_Laboratorio" class="form-control">
    	  <input type="hidden" name="ENo_Laboratorio" class="form-control">
          ...
          <div class="col-sm-9 col-md-9">
            ...
            <div class="form-group">
              <input type="text" id="txt-No_Laboratorio" name="No_Laboratorio" placeholder="Ingresar Nombre" class="form-control required" maxlength="100" autocomplete="off">
              <span class="help-block" id="error"></span>
            </div>
          </div>
