    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <div class="row div-Filtros div-Listar">
                <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2 d-none">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 d-none">
                  <div class="form-group">
                ...
                <div class="col-md-12 div-configurar_delivery_estandar">
                  <div class="form-group">
                    ...
                    <select id="cbo-Empresas" name="ID_Empresa_Item" class="form-control  required" style="width: 100%;"></select>
                    <span class="help-block" id="error"></span>
                  </div>
                </div>
                <?php } else { ?>
              ...
              <div class="box-body div-AgregarEditar" style="padding:0px">
                ...
                ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4  d-none"><!-- div-Producto -->
                        <div class="form-group">
                      ...
                      <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3  d-none">
                        <label>SubCate.</label>
                        ...
                        <div class="form-group">                    
                          <select id="cbo-sub_categoria" name="ID_Sub_Familia" class="form-control " style="width: 100%;"></select>
                          <span class="help-block" id="error"></span>
                        </div>
                      </div>
                      ...
                      <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3  d-none">
                        ...
                        <div class="form-group">
                          <select id="cbo-Marcas" name="ID_Marca" class="form-control " style="width: 100%;"></select>
                          <span class="help-block" id="error"></span>
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="row  d-none"><!-- ./productos variantes -->
                    <div class="col-xs-12">
                      ...
                      <div class="div-variantes_cuerpo  d-none">
                  ...
                  <div class="row  d-none"><!-- ./productos relacionados -->
                    <div class="col-xs-12">
                      ...
                      <br>
                      <div class="div-productos_relacionados_cuerpo  d-none">
                        ...
                        <div class="col-xs-12 div-productos_relacionados_aleatorio  d-none">
                          <div class="alert alert-warning">
                            <strong>IMPORTANTE:</strong> Al activar se visualizará 5 productos random en la vista de cada producto en la tienda.
                          </div>
                        </div>
                        <div class="col-xs-12 div-productos_relacionados_manual  d-none">
