            ...
            <?php $attributes = array('id' => 'form-agregar_pedido'); echo form_open('', $attributes); ?>
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3">
                  ...
                  <div class="form-group">
                    <input type="text" inputmode="tel" name="Nu_Celular_Entidad_Order_Address_Entry" class="form-control required" placeholder="Obligatorio" maxlength="15" autocomplete="off">
                    <span class="help-block" id="error"></span>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-3">
                  ...
                  <div class="form-group">
                    <input type="text" name="No_Ciudad_Dropshipping" class="form-control required" placeholder="Obligatorio" maxlength="100" autocomplete="on">
                    <span class="help-block" id="error"></span>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="Txt_Direccion_Entidad_Order_Address_Entry" class="form-control required" placeholder="Obligatorio" maxlength="255" autocomplete="off">
                    <span class="help-block" id="error"></span>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  ...
                  <div class="form-group">  
                    <!--<textarea name="Txt_Glosa" placeholder="Opcional" rows="5" class="form-control"></textarea>-->
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12"><h3><strong>Productos</strong></h3>
                  <label id="id_label_vendedor_whastapp" style="cursor: pointer;">WhastApp Vendedor
                    <a href="#" id="button-vendedor_whatsapp" alt="EcxpressLae Vendedor" title="EcxpressLae Vendedor" target="_blank">
                      <i class="fa fa-fw fa-whatsapp fa-2x" style="color: #25d366;"></i><span id="span-whatsapp-vendedor"></span>
                    </a>
                  </label>
                </div>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-xs-12">
            <label>Observaciones</label>
            <div class="form-group">
              <textarea name="Txt_Glosa_Pedido" class="form-control" placeholder="Ingresar" rows="5"></textarea>
              <span class="help-block" id="error"></span>
            </div>
          </div>
        </div>
...
<!-- Modal asignar_delivery -->
<div class="modal fade modal-asignar_delivery" id="modal-default">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="text-center">Asignar Delivery</h4>
      </div>
      <div class="modal-body">
        <input type="hidden" id="hidden-modal-id_pedido_cabecera_delivery" class="form-control" autocomplete="off">
        <div class="row">
          <div class="col-xs-12">
            <div class="form-group">
              <select id="cbo-delivery" name="ID_Usuario_Asignar_Delivery" class="form-control select2 required" style="width: 100%;"></select>
              <span class="help-block" id="error"></span>
            </div>
          </div>
        </div>
      ...
      <div class="modal-footer">
        ...
        <div class="col-xs-6 col-sm-6">
          <div class="form-group">
            <button type="button" id="btn-save_asignar_delivery" class="btn btn-success btn-lg btn-block pull-center">Guardar</button>
          </div>
        </div>
      </div>
    </div><!-- /.modal-content -->
...
<!-- Modal delivery_saldo_a_favor -->
<div class="modal fade modal-delivery_saldo_a_favor" id="modal-default">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="text-center">Delivery Saldo a Favor</h4>
      </div>
      <div class="modal-body">
        <input type="hidden" id="hidden-modal-id_pedido_cabecera_saldo_a_favor" class="form-control" autocomplete="off">
        <div class="row">
          <div class="col-xs-12">
            <label>Precio</label>
            <div class="form-group">
              <input type="text" inputmode="decimal" id="txt-modal-precio_delivery_saldo_a_favor" class="form-control required input-decimal" maxlength="13" autocomplete="off">
              <span class="help-block" id="error"></span>
            </div>
          </div>
        </div>
      ...
      <div class="modal-footer">
        ...
        <div class="col-xs-6 col-sm-6">
          <div class="form-group">
            <button type="button" id="btn-save_delivery_saldo_a_favor" class="btn btn-success btn-lg btn-block pull-center">Guardar</button>
          </div>
        </div>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /. Modal delivery_saldo_a_favor -->