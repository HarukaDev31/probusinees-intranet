          ...
          <div class="box-header box-header-new">
            <div class="row div-Filtros">
              ...
              <div class="col-md-3">
                ...
                <button type="button" class="btn btn-success btn-block" onclick="agregarMedioPago()"><i class="fa fa-plus-circle"></i> Agregar</button>
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table id="table-MedioPago" class="table table-striped table-bordered">
              ...
              <tr>
                ...
                <th>PLE</th>
                <th>FE</th>
                <th class="no-sort_left">Tipo Vista</th>
                <th class="no-sort">Dinero</th>
  ...
  <div class="modal-dialog">
      ...
      <div class="modal-header">
        ...
        <input type="hidden" name="EID_Empresa" class="form-control">
    	  ...
    	  <input type="hidden" name="ENo_Medio_Pago" class="form-control">
          ...
          <div class="col-xs-5 col-md-3">
            <div class="form-group">
              <label>PLE Codigo <span class="label-advertencia">*</span></label>
          ...
          <div class="col-xs-6 col-md-3">
            <div class="form-group">
              <label>FE Codigo <span class="label-advertencia"> *</span></label>
          ...
          <div class="col-xs-5 col-md-6">
            <div class="form-group">
              ...
              <!--<input type="tel" name="Nu_Tipo" placeholder="Ingresar codigo" class="form-control required" autocomplete="off" maxlength="3">-->
		  				<select id="cbo-tipo_vista" name="Nu_Tipo" class="form-control required" style="width: 100%;"></select>
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-5 col-md-3">
            <div class="form-group">
              <label>Dinero<span class="label-advertencia">*</span></label>
