...
<div class="content-wrapper">
        ...
        <div class="box box-content">
          ...
          <div class="box-header box-header-new">
            <div class="row div-Filtros">
              ...
              <div class="col-md-3">
                <div class="form-group">
    		  				<select id="cbo-Filtros_Monedas" name="Filtros_Monedas" class="form-control">
    		  				  <option value="Moneda">Nombre Moneda</option>
    		  				</select>
                </div>
              </div>
              ...
              <div class="col-md-3">
                ...
                <button type="button" class="btn btn-success btn-block" onclick="agregarMoneda()"><i class="fa fa-plus-circle"></i> Agregar</button>
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table id="table-Moneda" class="table table-striped table-bordered">
              <thead>
              <tr>
  ...
  <!-- Modal -->
  <?php
  $attributes = array('id' => 'form-Moneda');
  echo form_open('', $attributes);
  ?>
  <div class="modal fade" id="modal-Moneda" role="dialog">
  <div class="modal-dialog">
      ...
      <div class="modal-header">
        ...
        <input type="hidden" name="EID_Empresa" class="form-control">
    	  ...
    	  <input type="hidden" name="ENo_Moneda" class="form-control">
          ...
          <div class="col-xs-3 col-md-3">
            <div class="form-group">
              <label>Signo <span class="label-advertencia">*</span></label>
              <input type="text" name="No_Signo" placeholder="Ingresar signo" class="form-control required" autocomplete="off" maxlength="3">
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-4 col-md-6">
            <div class="form-group">
              ...
              <input type="text" id="txt-No_Moneda" name="No_Moneda" placeholder="Ingresar nombre" class="form-control required" autocomplete="off" maxlength="30">
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-5 col-md-3">
            <div class="form-group">
              ...
              <input type="text" name="Nu_Sunat_Codigo" placeholder="Ingresar codigo" class="form-control required" autocomplete="off" maxlength="3">
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-6 col-md-4">
            <div class="form-group">
              ...
              <input type="tel" name="Nu_Valor_FE" class="form-control required input-codigo_barra" placeholder="Ingresar número" autocomplete="off" maxlength="3">
              <span class="help-block" id="error"></span>
            </div>
          </div>
