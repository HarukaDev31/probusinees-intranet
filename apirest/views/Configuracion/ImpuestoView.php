...
<div class="content-wrapper">
      ...
      <div class="col-xs-12">
        <div class="box box-content">
          ...
          <div class="box-header box-header-new">
            <div class="row div-Filtros">
              ...
              <div class="col-md-3">
                <div class="form-group">
    		  				<select id="cbo-Filtros_Impuestos" name="Filtros_Impuestos" class="form-control">
    		  				  <option value="Impuesto">Nombre Impuesto</option>
    		  				</select>
                </div>
              </div>
              ...
              <div class="col-md-3">
                ...
                <button type="button" class="btn btn-success btn-block" onclick="agregarImpuesto()"><i class="fa fa-plus-circle"></i> Agregar</button>
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table id="table-Impuesto" class="table table-striped table-bordered">
              <thead>
                <tr>
  ...
  <!-- Modal -->
  <?php
  $attributes = array('id' => 'form-Impuesto');
  echo form_open('', $attributes);
  ?>
  <div class="modal fade" id="modal-Impuesto" role="dialog">
  <div class="modal-dialog">
      ...
      <div class="modal-header">
        ...
        <input type="hidden" name="EID_Empresa" class="form-control">
    	  ...
    	  <input type="hidden" name="ENo_Impuesto" class="form-control">
          ...
          <div class="col-xs-12 col-md-8">
            <div class="form-group">
              ...
              <input type="text" id="txt-No_Impuesto" name="No_Impuesto" class="form-control required" placeholder="Ingresar nombre" autocomplete="off" maxlength="50">
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="No_Impuesto_Breve" class="form-control required" placeholder="Ingresar nombre breve" autocomplete="off" maxlength="20">
              <span class="help-block" id="error"></span>
            </div>
          </div>
        </div>
          ...
          <div class="col-xs-6 col-md-4">
            <div class="form-group">
              <label>Grupo Impuesto <span class="label-advertencia"> *</span></label>
              <!--<input type="tel" name="Nu_Tipo_Impuesto" class="form-control required input-number" placeholder="Ingresar número" autocomplete="off" maxlength="1">-->
              <select id="cbo-grupo_impuesto" name="Nu_Tipo_Impuesto" class="form-control required" style="width: 100%;"></select>
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-6 col-md-4">
            <div class="form-group">
              ...
              <input type="tel" name="Nu_Valor_FE" class="form-control required input-number" placeholder="Ingresar número" autocomplete="off" maxlength="2">
              <span class="help-block" id="error"></span>
            </div>
          </div>
        </div>
