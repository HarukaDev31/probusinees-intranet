...
<div class="content-wrapper">
        ...
        <div class="box box-content">
          ...
          <div class="box-header box-header-new">
            <div class="row div-Filtros">
              ...
              <div class="col-md-3">
                <div class="form-group">
    		  				<select id="cbo-Filtros_MedioPagoMarketplace" name="Filtros_MedioPagoMarketplace" class="form-control">
    		  				  <option value="MedioPagoMarketplace">Nombre Medio Pago</option>
    		  				</select>
                </div>
              </div>
              ...
              <div class="col-md-3">
                ...
                <button type="button" class="btn btn-success btn-block" onclick="agregarMedioPagoMarketplace()"><i class="fa fa-plus-circle"></i> Agregar</button>
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table id="table-MedioPagoMarketplace" class="table table-striped table-bordered">
              <thead>
              <tr>
  ...
  <!-- Modal -->
  <?php
  $attributes = array('id' => 'form-MedioPagoMarketplace');
  echo form_open('', $attributes);
  ?>
  <div class="modal fade" id="modal-MedioPagoMarketplace" role="dialog">
  <div class="modal-dialog modal-lg">
      ...
      <div class="modal-header">
    	...
    	<div class="modal-body">
    	  ...
    	  <input type="hidden" name="ENo_Medio_Pago_Marketplace" class="form-control">
          ...
          <div class="col-xs-4 col-md-3">
            <div class="form-group">
              ...
              <input type="text" id="txt-No_Medio_Pago_Marketplace" name="No_Medio_Pago_Marketplace" placeholder="Ingresar nombre" class="form-control required" autocomplete="off" maxlength="50">
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-4 col-md-5">
            <div class="form-group">
              ...
              <input type="text" id="txt-Txt_Medio_Pago_Marketplace" name="Txt_Medio_Pago_Marketplace" placeholder="Ingresar descripción" class="form-control" autocomplete="off" maxlength="250">
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-5 col-md-2">
            <div class="form-group">
              <label>Nro. Orden <span class="label-advertencia">*</span></label>
              <input type="tel" name="Nu_Orden" placeholder="Ingresar" class="form-control required" autocomplete="off" maxlength="3">
              <span class="help-block" id="error"></span>
            </div>
          </div>
          
          <div class="col-xs-12 col-md-2 div-Estado">
            <div class="form-group">
