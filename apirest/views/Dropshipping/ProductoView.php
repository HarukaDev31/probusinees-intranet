            ...
            <table id="table-Producto" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th class="sort_right">Oferta</th>
                  <th class="no-sort">Tienda</th>
                  <th class="no-sort">Destacado</th>
              ...
              <div class="row">
                <div class="col-md-9">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group">
                      <label>Precio</label>
                      <input type="text" name="Ss_Precio_Ecommerce_Online_Regular" inputmode="decimal" class="form-control required input-decimal" maxlength="13" autocomplete="off" value="" placeholder="Obligatorio">
                      <span class="help-block" id="error"></span>
                    </div>
                  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <form name="importa" method="post" action="<?php echo base_url(); ?>Dropshipping/ProductosDropshippingController/importarExcelProductos" enctype="multipart/form-data">
          <div class="row">
