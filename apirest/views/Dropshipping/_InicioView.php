...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-4">
    <div class="box box-primary">
      ...
      <!-- /.box-body -->
      <div class="box-footer text-center"><a class="btn btn-success btn-block small-box-footer" href="<?php echo base_url() . 'Logistica/ReglasLogistica/ProductoController/listarProductos'; ?>">Ver ítems &nbsp; <i class="fa fa-arrow-circle-right"></i></a></div>
    </div>
