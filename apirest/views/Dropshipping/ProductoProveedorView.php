          ...
          <div class="box-header box-header-new div-Listar">
            <div class="row div-Filtros">
              ...
              <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10">
                <div class="form-group">
                  <input type="text" id="txt-Global_Filter" name="Global_Filter" class="form-control" maxlength="250" placeholder="Buscar item" value="" autocomplete="off">
                </div>
              </div>
              ...
              <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 hidden">
              ...
              <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 div-mas_opciones" style="">
            ...
            <table id="table-Producto" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th class="sort_right" title="Precio de Venta Proveedor">P.V. Proveedor</th>
                  <th class="sort_right" title="Precio Sugerido de Venta para Vendedor">P.V. Sugerido</th>
                  <th class="no-sort img_sort">Imagen</th>
                  <th class="no-sort">Ver</th>
                  <th class="no-sort">Agregar</th>
                </tr>
              </thead>
            </table>
          </div>
              ...
              <div class="row">
                <div class="col-md-9">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group">
                      ...
                      <input type="text" name="Ss_Precio_Vendedor_Dropshipping" inputmode="decimal" class="form-control input-decimal" maxlength="13" autocomplete="off" value="" placeholder="Opcional">
                      <span class="help-block" id="error"></span>
                    </div>
                  </div>
                ...
                <div class="col-md-3 col-lg-3" style="padding: 0px;">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center" >
                    <div id="id-divDropzone" style="border: 2px dashed #bfbfbf !important;
padding: 1rem 1rem;
margin-top: 1rem;
cursor: pointer;
margin-bottom: 1.5rem;">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group">
                    <button type="submit" id="btn-save_producto_proveedor" class="btn btn-success btn-lg btn-block">Crear Producto</button>
                  </div>
                </div>
