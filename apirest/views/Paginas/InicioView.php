    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="box box-content">
          ...
          <div class="box-header box-header-new">
            <div class="row div-Filtros">
              ...
              <div class="col-md-3">
                <div class="form-group">
    		  				<select id="cbo-Filtros_Inicios" name="Filtros_Inicios" class="form-control">
    		  				  <option value="Inicio">Nombre oferta</option>
    		  				</select>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <?php if ($this->MenuModel->verificarAccesoMenuCRUD()->Nu_Agregar == 1) : ?>
                <button type="button" class="btn btn-success btn-block" onclick="agregarInicio('2')"><i class="fa fa-plus-circle"></i> Agregar</button>
                <?php endif; ?>
              </div>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="table-responsive">
            <table id="table-oferta" class="table table-striped table-bordered">
              <thead>
                <tr>
                  <th>Nombre</th>
                  <th>Imágen</th>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <div class="well well-sm">
                ...
                <br>- Tamaño imagén Tablet y Pc<b>Alto: 1200px y Ancho: 350px</b>
                <br>- Tamaño imagén Celular<b>Alto: 1200px y Ancho: 700px</b>
