...
<div class="content-wrapper">  
      ...
      <div class="col-xs-12">
        <div class="box box-content">
            ...
            <div class="row div-Filtros">
              ...
              <div class="col-sm-5 col-md-3">
                <div class="form-group">
    		  				<select id="cbo-Filtros_Deliverys" name="Filtros_Deliverys" class="form-control">
    		  				  <option value="Delivery">Nombre</option>
              ...
              <div class="col-sm-12 col-md-3">
                ...
                <button type="button" class="btn btn-success btn-block" onclick="agregarDelivery()"><i class="fa fa-plus-circle"></i> Agregar</button>
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table id="table-Delivery" class="table table-striped table-bordered">
              <thead>
                <tr>
                  <th>Tipo</th>
                  <th>Número</th>
  ...
  <!-- Modal -->
  <?php
  $attributes = array('id' => 'form-Delivery');
  ...
  <div class="modal-dialog">
      ...
      <div class="modal-header">
    	...
    	<div class="modal-body">
          ...
          <div id="div-api-dni_ruc" class="col-xs-4 col-sm-2 col-md-4 text-center">
            <label>Api</label>
            <div class="form-group">
          ...
          <div class="col-xs-8 col-sm-5 col-md-9">
            <label id="label-No_Entidad">Nombre(s) y Apellidos <span class="label-advertencia">*</span></label>
            <div class="form-group">
