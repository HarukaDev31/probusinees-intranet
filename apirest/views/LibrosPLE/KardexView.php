...
-->
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 div-mas_opciones">
                ...
                <div class="form-group">
                  <label style="cursor:pointer; font-weight:normal"><input type="radio" id="radio-filtro_item_con_movimiento" class="flat-red" name="radio-filtro_item_movimiento" value="2" checked>&nbsp; Con movimientos 
                  ...
                  &nbsp;&nbsp;<label style="cursor:pointer; font-weight:normal"><input type="radio" id="radio-filtro_item_ambos_movimiento" class="flat-red" name="radio-filtro_item_movimiento" value="1">&nbsp; ambos movimientos
