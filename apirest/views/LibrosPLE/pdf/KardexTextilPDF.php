        ...
        if ( $arrDetalle['sStatus'] == 'success' ) {
            ...
            for ($i=0; $i < count($arrDetalle['arrData']); $i++) {
                ...
                if ($ID_Producto != $row->ID_Producto || $ID_Almacen != $row->ID_Almacen) {
                    ...
                    if ($counter != 0) { ?>
                        <tr class="tr-theadFormat tr-theadFormat_header">
                            ...
                            <th class="text-right"><?php echo $Qt_Producto_Saldo_Movimiento; ?></th>
                        </tr>
                    <?php
                    }
                    ...
                    if ($ID_Almacen != $row->ID_Almacen) {
                        if ($counter_almacen != 0) {?>
                            <tr class="tr-theadFormat tr-theadFormat_footer">
                                ...
                                <th class="text-right"><?php echo $fSumSaldoInicialxProductoAlmacen; ?></th>
                                <th class="text-right"><?php echo ($fSumSaldoInicialxProductoAlmacen + $sum_Almacen_Producto_Qt_Entrada - $sum_Almacen_Producto_Qt_Salida); ?></th>
                            </tr>
                            <?php
                        }
                ...
                <?php
                    ...
                    $sum_Producto_Qt_Entrada = 0.00;
                    $sum_Producto_Qt_Salida = 0.00;
                    $fSumSaldoInicialxProductoAlmacen += $row->Qt_Producto_Inicial;
                } // /. if producto
                ?>
                <tr class="tr-theadFormat">
            ...
            <?php
            $ID_Almacen = 0;
            for ($p = 0; $p < count($arrDetalle['arrDataAlmacenSinMovimiento'][0]); $p++) {
                $row_producto = $arrDetalle['arrDataAlmacenSinMovimiento'][0]; ?>
                <br><br>
                <tr class="tr-theadFormat">
                    <td class="text-left" colspan="3">PERIODO: </td>
                    <th class="text-left" colspan="8"><?php echo $fMonth . ' ' . $fYear; ?></th>
                ...
                <tr class="tr-theadFormat">
                    <td class="text-left" colspan="3">ALMACÉN: </td>
                    <th class="text-left" colspan="8"><?php echo $row_producto[$p]->No_Almacen; ?></th>
                </tr>
                <tr class="tr-theadFormat">
                    <td class="text-left" colspan="3">UPC: </td>
