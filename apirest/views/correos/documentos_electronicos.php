                        ...
                        <tr>
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr height="10">
                                        <td width="32px">Se adjunta en este mensaje una <?php echo $No_Documento; ?></td>
                                    </tr>
                                    <tr height="10">
                                        <td width="32px">
                                            <ul>
                                                ...
                                                <li>Forma de Pago: <b><?php echo $Txt_Medio_Pago; ?></b></li>
                                                <li>Total: <b><?php echo $No_Signo . ' ' . $Ss_Total; ?></b></li>
                                                <?php if($Nu_Tipo == 1) { ?>
                                                    <li>Saldo: <b><?php echo $No_Signo . ' ' . $Ss_Total_Saldo; ?></b></li>
                                                <?php } ?>
                                            </ul>
                                        </td>
                                    </tr>
                                    <tr height="10">
                                        <td width="32px">Se adjunta en este mensaje el documento electrónico en formatos PDF y XML. La representación impresa en PDF tiene la misma validez que una emitida de manera tradicional.</td>
                                    </tr>
                                    <tr height="10">
                                        <td width="32px"><br></td>
                                    </tr>
                                    <tr height="10">
                                        <td width="32px">También puedes ver el documento dandole click aquí.</td>
                                    </tr>
                                    <tr height="10">
                                        <td width="32px"><br></td>
                                    </tr>
                                    <tr height="10">
                                        <td width="32px" align="center">
                                            <a href="<?php echo $url_comprobante; ?>" id="btn-ver_documento" target="_blank">Ver documento</a>                             
                                        </td>
                                    </tr>
                                    <tr height="10">
                                        <td width="32px"><br></td>
