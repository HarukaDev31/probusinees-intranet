...
<div class="content-wrapper">  
  ...
  <section class="content">
    ...
    <div class="modal fade modal-finalizar_pedido_Embolsado" id="modal-default">
          ...
          <div class="modal-body">
            ...
            <div class="row" id="div-pin_finalizado">
              <div class="col-xs-2">
                <label>PIN</label>
                <div class="form-group">
                  <input type="password" id="tel-pin_finalizado" class="form-control input-number" value="" autocomplete="off" placeholder="Ingresar pin 4 dígitos" maxlength="4" inputmode="numeric">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
              <div class="col-xs-10">
          ...
          <div class="modal-footer">
            <div class="row">
              <div class="col-xs-12 text-left div-detalle_item_pedido_finalizado">
                <label>Nota</label>
                <div class="form-group">
                  <textarea name="Txt_Embolsado" class="form-control"></textarea>
                </div>
              </div>
