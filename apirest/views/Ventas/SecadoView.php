...
<div class="content-wrapper">  
  ...
  <section class="content">
    ...
    <!-- /.row -->
    <!-- Modal delivery -->
    <div class="modal fade modal-tomar_pedido_Secado" id="modal-default">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="text-center">Nro. Pedido <label id="modal-header-label-title_tomar"></label></h4>
          ...
          <div class="modal-body">
            ...
            <div class="row" id="div-pin">
              <div class="col-xs-2">
                <label>PIN</label>
                <div class="form-group">
                  <input type="tel" id="tel-pin" class="form-control input-number" value="" autocomplete="off" placeholder="Ingresar pin 4 dígitos" maxlength="4">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
              <div class="col-xs-10">
