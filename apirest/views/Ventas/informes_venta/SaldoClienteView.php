          ...
          <div class="box-header box-header-new">
            <div class="row div-Filtros">
              ...
              <div class="col-xs-12 col-sm-4 col-md-2">
                <div class="form-group">
                  <label>Almacén</label>
    		  				<select id="cbo-Almacenes_SaldoCliente" class="form-control select2" style="width: 100%;"></select>
            ...
            <div class="row div-Filtros">
              ...
              <div class="col-xs-4 col-md-4">
                <div class="form-group">
                  <button type="button" id="btn-html_saldo_cliente" class="btn btn-primary btn-block btn-saldo_cliente" data-type="html"><i class="fa fa-search"></i> Buscar</button>
                </div>
              </div>
              
              <div class="col-xs-4 col-md-4">
                <div class="form-group">
                  <button type="button" id="btn-pdf_saldo_cliente" class="btn btn-danger btn-block btn-saldo_cliente" data-type="pdf"><i class="fa fa-file-pdf-o color_white"></i> PDF</button>
                </div>
              </div>
              
              <div class="col-xs-4 col-md-4">
                <div class="form-group">
                  <button type="button" id="btn-excel_saldo_cliente" class="btn btn-success btn-block btn-saldo_cliente" data-type="excel"><i class="fa fa-file-excel-o color_white"></i> Excel</button>
                </div>
              </div>
            </div>
          </div>
          <!-- /.box-header -->
          <div id="div-saldo_cliente" class="table-responsive">
            <table id="table-saldo_cliente" class="table table-striped table-bordered">
              <thead>
                <tr>
