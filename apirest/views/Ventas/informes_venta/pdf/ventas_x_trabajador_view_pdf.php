      ...
      <table class="table_pdf">
        <thead>
          ...
          <tr class="tr-theadFormatTitle">
            <th align="center" colspan="2">Informe de Ventas por Personal</th>
          </tr>
          <tr class="tr-theadFormat">
                ...
                if ($ID_Almacen != $row->ID_Almacen) {
                  if ($counter_almacen != 0) { ?>
                    <tr class="tr-theadFormat tr-theadFormat_footer">
                      ...
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compras_cantidad, 3, '.', ','); ?></th>
                      <th class="text-right">&nbsp;</th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compras_subtotal_s, 2, '.', ','); ?></th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compras_igv_s, 2, '.', ','); ?></th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compras_descuento_s, 2, '.', ','); ?></th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compras_total_s, 2, '.', ','); ?></th>
                      <th class="text-right"><?php echo numberFormat($sum_almacen_compras_total_d, 2, '.', ','); ?></th>
