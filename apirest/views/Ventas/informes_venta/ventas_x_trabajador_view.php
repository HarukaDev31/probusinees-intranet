            ...
            <div class="row div-Filtros">
              ...
              <div class="col-xs-12 col-sm-6 col-md-5 col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" id="txt-Filtro_Entidad" class="form-control autocompletar" data-global-class_method="AutocompleteController/getAllEmployee" data-global-table="entidad" placeholder="Buscar por Nombre / Nro. Documento Identidad" value="" autocomplete="off">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
