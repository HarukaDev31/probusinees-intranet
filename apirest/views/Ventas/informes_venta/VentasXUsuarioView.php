            ...
            <div class="row div-Filtros">
              ...
              <div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
                <div class="form-group">
                  <label>Almacén</label>
    		  				<select id="cbo-Almacenes_VentasxTrabajador" class="form-control select2" style="width: 100%;"></select>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" id="txt-Filtro_Entidad" class="form-control autocompletar_ventas_x_usuario" data-global-class_method="AutocompleteController/obtenerUsuarios" data-global-table="entidad" placeholder="Buscar por usuario" value="" autocomplete="off">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
                ...
                <div class="form-group">
                  <label>Tipo de Venta</label>
    		  				<select id="cbo-tipo_venta" class="form-control" style="width: 100%;">
    		  				  <option value="1">Vender (Oficina)</option>
              ...
              <div class="col-xs-12 col-sm-6 col-md-5 div-mas_opciones">
                <div class="form-group">
              ...
              <div class="col-xs-12">
                <label></label>
                <div class="form-group">
                  <label style="cursor:pointer"><input type="radio" name="radio-tipo-reporte-ventas_x_trabajador" class="flat-red" value="0" checked> Detallado</label>
                  &nbsp;&nbsp;<label style="cursor:pointer"><input type="radio" name="radio-tipo-reporte-ventas_x_trabajador" class="flat-red" value="1"> Resumido</label>
                </div>                          
              </div>
            </div>
