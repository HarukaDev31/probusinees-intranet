...
<div class="content-wrapper">  
  ...
  <section class="content">
      ...
      <div class="col-xs-12">
        <div class="box box-content">
          ...
          <div id="div-proceso_planta_lavanderia" class="table-responsive">
            <form id="form-proceso_planta_lavanderia" enctype="multipart/form-data" method="post" role="form" autocomplete="off">
    ...
    <div class="modal fade modal-finalizar_pedido_LavadoSeco" id="modal-default">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 id="h4-datos_item_finalizado" class="text-center" style="display:none"></h5>
          ...
          <div class="modal-footer">
            <div class="row">
              <div class="col-xs-8 text-left div-detalle_item_pedido_finalizado">
                <label>Nota</label>
                <div class="form-group">
                  <textarea name="Txt_Final_Lavado_Seco" class="form-control"></textarea>
                </div>
              </div>
              ...
              <div class="col-xs-12 div-detalle_item_pedido_finalizado">
                <div class="form-group">
                  <button type="button" id="btn-finalizar_pedido" class="btn btn-primary btn-md btn-block pull-center">Finalizar</button>
                </div>
              </div>
