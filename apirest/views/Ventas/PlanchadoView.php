...
<div class="content-wrapper">  
  ...
  <section class="content">
    ...
    <div class="modal fade modal-finalizar_pedido_Planchado" id="modal-default">
          ...
          <div class="modal-footer">
            <div class="row">
              <div class="col-xs-8 text-left div-detalle_item_pedido_finalizado">
                <label>Nota</label>
                <div class="form-group">
                  <textarea name="Txt_Planchado" class="form-control"></textarea>
                </div>
              </div>
              <div class="col-xs-4 text-left div-detalle_item_pedido_finalizado">
