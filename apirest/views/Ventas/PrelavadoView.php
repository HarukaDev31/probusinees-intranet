...
<div class="content-wrapper">  
  ...
  <section class="content">
            ...
            <table id="table-proceso_planta_lavanderia" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Tipo Lavado</th>-->
    ...
    <!-- /.row -->
    <!-- Modal delivery -->
    <div class="modal fade modal-tomar_pedido_prelavado" id="modal-default">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="text-center"><label id="modal-header-label-title_tomar"></label></h4>
            <h5 id="h4-datos_personal" class="text-center"></h5>
          ...
          <div class="modal-body">
            <input type="hidden" id="hidden-iIdDocumentoCabecera" value="">
            <input type="hidden" id="hidden-iIdDocumentoDetalle" value="">
            <input type="hidden" id="hidden-iIdEntidad" value="">
            
            <div class="row" id="div-pin">
              <div class="col-xs-2">
                <label>PIN</label>
                <div class="form-group">
                  <input type="password" id="tel-pin" class="form-control input-number" value="" autocomplete="off" placeholder="Ingresar pin 4 dígitos" maxlength="4" inputmode="numeric">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
              <div class="col-xs-10">
                <label>&nbsp;</label>
                <div class="form-group">
                  <button type="button" id="btn-validar_pin_personal" class="btn btn-success btn-md btn-block pull-center">Entrar</button>
                </div>
              </div>
            </div><!-- /. row PIN -->
            ...
            <div class="row" id="div-detalle_item_pedido">
              ...
              <div class="col-xs-7">
                <label>Item</label>
                <div class="form-group">
                  <input type="hidden" id="txt-id_item" class="form-control">
                  <input type="text" id="txt-item" class="form-control autocompletar_detalle_version2" data-global-class_method="AutocompleteController/globalAutocomplete" data-global-table="producto" placeholder="Ingresar nombre / código de barra / código sku" value="" autocomplete="off">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
          ...
          <div class="modal-footer">
            <div class="col-xs-12">
              <div class="form-group">
                <button type="button" id="btn-procesar_pedido" class="btn btn-primary btn-md btn-block pull-center">Iniciar pedido</button>
              </div>
            </div>
    ...
    <div class="modal fade modal-finalizar_pedido_prelavado" id="modal-default">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="text-center"><label id="modal-header-label-title_finalizado"></label></h4>
            <h5 id="h4-datos_item_finalizado_prelavado" class="text-center"></h5>
          ...
          <div class="modal-body">
            ...
            <input type="hidden" id="hidden-iEstadoLavado" value="">
            ...
            <div class="row div-detalle_item_pedido_finalizado">
              <div class="col-xs-12"><h4 id="h4-datos_personal_finalizado" class="text-center"></h4></div>
          ...
          <div class="modal-footer">
            <div class="row">
              <div class="col-xs-8 text-left div-detalle_item_pedido_finalizado">
                <label>Nota</label>
                <div class="form-group">
                  <textarea name="Txt_Final_Prelavado" class="form-control"></textarea>
                </div>
              </div>
              <div class="col-xs-4 text-left div-estado_lavado">
