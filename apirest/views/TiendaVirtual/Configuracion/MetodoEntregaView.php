...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box box-content hidden">
          <!-- box-header -->
            ...
            <div class="row div-Filtros">
              ...
              <div class="col-md-12 div-configurar_delivery_estandar">
                <div class="form-group">
                  ...
                  <select id="cbo-Empresas" name="ID_Empresa_Estandar_Delivery" class="form-control select2 required" style="width: 100%;"></select>
        ...
        <div class="row div-recojo_tienda">
          ...
          <div class="col-xs-6 col-sm-4 col-md-4 hidden">
            <div class="form-group">
              ...
              <select id="cbo-Paises-recojo_tienda" name="ID_Pais-recojo_tienda" class="form-control select2 required" style="width: 100%;"></select>
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-6 col-sm-4 col-md-4">
            <div class="form-group">
              ...
              <select id="cbo-Departamentos-recojo_tienda" name="ID_Departamento-recojo_tienda" class="form-control select2 required" style="width: 100%;"></select>
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-6 col-sm-4 col-md-4">
            <div class="form-group">
              ...
              <select id="cbo-Provincias-recojo_tienda" name="ID_Provincia-recojo_tienda" class="form-control select2 required" style="width: 100%;"></select>
              <span class="help-block" id="error"></span>
            </div>
          </div>
  ...
  <div class="modal-dialog">
      ...
      <div class="modal-header">
    	...
    	<div class="modal-body">
          ...
          <div class="col-xs-6 col-sm-3 col-md-6 hidden">
          ...
          <div class="col-xs-6 col-sm-9 col-md-3 hidden">
            <label>Estado <span class="label-advertencia">*</span></label>
            <div class="form-group">
		  				<select id="cbo-Estado" name="Nu_Estado" class="form-control required" style="width: 100%;"></select>
              <span class="help-block" id="error"></span>
