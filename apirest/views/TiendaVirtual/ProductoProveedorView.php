          ...
          <div class="box-header box-header-new div-Listar">
            <div class="row div-Filtros">
              ...
              <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                ...
                <div class="form-group">
                  <select id="cbo-filtro-proveedores" name="ID_Filtro_Proveedor" class="form-control select2 required" style="width: 100%;"></select>
                  <span class="help-block" id="error"></span>
                </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                ...
                <div class="form-group">
                  <select id="cbo-filtro-almacenes" name="ID_Filtro_Almacen" class="form-control select2 required" style="width: 100%;"></select>
                  <span class="help-block" id="error"></span>
                </div>
              </div>
            ...
            <table id="table-Producto" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th class="sort_right" title="Precio Proveedor">Precio Proveedor</th>
                  <th class="sort_right" title="Precio Venta Sugerido">Precio Sugerido</th>
