            ...
            <div class="row div-Filtros">
              ...
              <div class="col-md-3">
                <div class="form-group">
                    ...
                    <option value="Sub_Categoria">Nombre SubCategoría</option>
    		  				</select>
                </div>
              </div>
  ...
  <div class="modal-dialog modal-lg">
      ...
      <div class="modal-header">
    	...
    	<div class="modal-body">
    	  ...
    	  <input type="hidden" name="EID_Sub_Familia" class="form-control">
    	  <input type="hidden" name="ENo_Sub_Familia" class="form-control">
          ...
          <div class="col-xs-6 col-sm-6 col-md-4">
            ...
            <a class="btn btn-link" target="_blank" style="padding:0px; color: #7b7b7b" href="<?php echo base_url() . 'Logistica/ReglasLogistica/TiendaVirtual/CategoriasTiendaVirtualController/listar'; ?>">[Crear]</a>
            <div class="form-group">                    
