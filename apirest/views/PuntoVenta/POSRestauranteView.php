...
<div class="content-wrapper">
  <!-- Main content -->
  <section class="content section-pos_restaurante" style="background: #eeeeee;">
    <div class="row">
      <?php
      //array_debug($rowImpuestoGratuita);
      ...
      <div class="col-xs-12 col-sm-5">
        ...
        <div class="row" style="background: #fcfcfc !important; padding: 0px; margin-bottom: 0px; margin-right: 0px; border-radius: 0.3em;">
          <input type="hidden" id="hidden-id_escenario_restaurante" value="<?php echo $iIdEscenarioRestaurante; ?>">
          <input type="hidden" id="hidden-id_escenario_mesa_restaurante" value="<?php echo $iIdEscenarioMesaRestaurante; ?>">
          <input type="hidden" id="hidden-iIdPedidoCabecera" value="<?php echo $iIdPedidoCabecera; ?>">

          <div class="col-xs-2 col-sm-2 col-md-3 col-lg-3">
            <label>&nbsp;</label>
            <button type="button" class="btn btn-block btn-default back-history"><i class="fa fa-chevron-left"></i> &nbsp;<span class="hidden-xs hidden-sm hidden-md">Regresar</span> </button>
          </div>
          
          <div class="col-xs-5 col-sm-6 col-md-4 col-lg-5">
            <label>Mesa</label>
            <div class="form-group">
              <select id="cbo-mesa" class="form-control required select2" style="width: 100%;"></select>
              <span class="help-block" id="error"></span>
            </div>
          </div>
          
          <div class="col-xs-5 col-sm-4 col-md-5 col-lg-4">
            <label><span class="hidden-xs hidden-sm">Nro. </span>persona</label>
            <div class="form-group">
              <input type="tel" id="txt-Nu_Cantidad_Personas_Restaurante" name="Nu_Cantidad_Personas_Restaurante" class="form-control hotkey-cobrar_cliente hotkey-cancelar_venta hotkey-limpiar_item hotkey-focus_item" autocomplete="off" placeholder="opcional">
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="form-group">
              ...
              <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Buscar por Nombre / Código de Barra (UPC) / Código SKU. Para agregar nuevos ítems usar el botón (+) o Compras y Productos > Reglas de Productos > Productos">
      ...
      <div class="col-xs-12 col-sm-7 sidenav" style="background: #fcfcfc !important; padding: 10px; margin-bottom: 15px; border-radius: 0.3em;">
        <div class="row">
            ...
            <div class="form-group">
              <select id="cbo-tipo_documento" name="tipo_documento" class="form-control hotkey-cobrar_cliente" style="width: 100%;">
                <?php if($this->empresa->Nu_Tipo_Proveedor_FE != 3) { ?>
                  <option value="4" data-nu_cantidad_caracteres="8" title="Puedes registrar cliente con DNI / Nombres" alt="Puedes registrar cliente con DNI / Nombres">Boleta</option>
          ...
          <div class="col-xs-6 col-sm-5 col-md-3 div-nuevo_cliente">
            ...
            <div class="form-group">
              ...
              <input type="text" id="txt-ACodigo" name="Nu_Documento_Identidad" class="form-control autocompletar input-Mayuscula input-codigo_barra hotkey-cancelar_venta hotkey-cobrar_cliente hotkey-focus_item" onkeyup="api_sunat_reniec(this.value);" data-global-class_method="AutocompleteController/getAllClient" data-global-table="entidad" placeholder="opcional" title="Si existe cliente ingresar Nombre / # Doc. Ident." maxlength="8" autocomplete="off">
              <span class="help-block" id="error"></span>
            </div>
          </div>

          <div class="col-xs-6 col-sm-6 col-md-5 div-nuevo_cliente">
            <label id="label-No_Entidad">Nombre</label><span id="span-no_nombres_cargando"></span>
        ...
        <div class="row">
          <div class="col-xs-12 div-lista_compra_items" style="height: 240px; overflow-y: auto;"><!-- 275px 350px -->
        ...
        <div class="row" style="margin-top: 2%;">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Para desactivar / activar descuento ir a Configuración > Configurar empresa y sistena">
              <i class="fa fa-info-circle"></i>
            </span>
            <div class="form-group">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <span class="hidden-xs hidden-sm hidden-md" style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Para habilitar descuento ir a Configuración > Configurar empresa y sistema">
              <i class="fa fa-info-circle"></i>
            </span>
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-xs-6 col-sm-6 col-md-3">
            <div class="form-group">
              <button title="Imprimir o envía por whatsapp si marca SI" type="button" id="btn-imprimir_pre_cuenta" data-id="1" class="btn btn-default btn-xs btn-block btn-imprimir_pre_cuenta_y_guardar">
                <div class="col-xs-12">
                  <h5>Imprimir precuenta</h5>
                </div>
              </button>
            </div>
          </div>
          <div class="col-xs-6 col-sm-6 col-md-3">
            <div class="form-group">
              <button title="Imprimir" type="button" id="btn-imprimir_pre_cuenta" data-id="1" class="btn btn-default btn-xs btn-block btn-imprimir_comanda_cocina">
                <div class="col-xs-12">
                  <h5>Imprimir comanda</h5>
                </div>
              </button>
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
              <button type="button" id="btn-guarda_pre_venta" data-id="2" class="btn btn-success btn-xs btn-block btn-imprimir_pre_cuenta_y_guardar">
                <div class="col-xs-7 text-left">
                  <h5 id="h4-guardar_pre_venta">Guardar precuenta</h5>
                </div>
            ...
            <div class="form-group">
              <button type="button" id="btn-pagar" class="btn btn-primary btn-lg btn-block">
                ...
                <div class="col-xs-5 text-right">
                  ...
                  <input type="hidden" class="hidden-gratuita" value="" autocomplete="off">
