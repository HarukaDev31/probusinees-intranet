  ...
  <section class="content" style="background: #eeeeee;">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-5">
        ...
        <div class="row" style="background: transparent !important; padding: 0px; margin-bottom: 0; margin-right: 0px; border-radius: 0.3em;">
          <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6">
            <label>L. Precio</label>
            <span style="cursor: pointer;" class="hidden-sm hidden-md" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Para configurar múltiples lista de precios, debemos de ingresar a la opción Ventas -> Reglas de Venta -> Lista de Precios">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="form-group">
              ...
              <?php } ?>
                <input type="text" id="txt-No_Producto" class="form-control autocompletar_lector_codigo_barra hotkey-limpiar_item hotkey-cancelar_venta" data-global-class_method="AutocompleteController/getAllProduct" data-global-table="producto" onkeyup="autocompleteItemsAlternativos(this.value);" placeholder="Bucar por Nombre / Código Barra / Código SKU" value="" autocomplete="off">
                <?php if($bStatusOpcionProductoAdd==1) { ?>
      ...
      <div class="col-xs-12 col-sm-7 sidenav" style="background: #fcfcfc !important; padding: 10px; margin-bottom: 15px; border-radius: 0.3em;">
        <div class="row">
          ...
          <div class="col-xs-6 col-sm-4 col-md-2 div-nuevo_cliente" style="padding-right: 0px;">
            ...
            <div class="form-group">
              <select id="cbo-tipo_documento" name="tipo_documento" class="form-control hotkey-cobrar_cliente" style="width: 100%;">
                <option value="2">Orden Lavado</option>
              </select>
            </div>
          </div>
          ...
          <div class="col-xs-6 col-sm-5 col-md-3 div-nuevo_cliente">
            ...
            <div class="form-group">
              ...
              <input type="text" id="txt-ACodigo" name="Nu_Documento_Identidad" class="form-control autocompletar input-Mayuscula input-codigo_barra hotkey-cancelar_venta hotkey-cobrar_cliente hotkey-focus_item" onkeyup="api_sunat_reniec(this.value);" data-global-class_method="AutocompleteController/getAllClient" data-global-table="entidad" placeholder="opcional" title="Si existe cliente ingresar Nombre / # Doc. Ident." maxlength="15" autocomplete="off">
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-4 col-sm-6 col-md-6 col-lg-6 div-nuevo_cliente"><!--div-nuevo_cliente-->
            <div class="form-group">
          ...
          <div class="col-xs-4 col-sm-4 col-md-3 col-lg-3 div-nuevo_cliente">
            <div class="form-group">
              <label>Celular</label>
          ...
          <div class="col-xs-4 col-sm-2 col-md-3 col-lg-3 div-nuevo_cliente">
        ...
        <div class="row" style="margin-top: 2%;">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Para habilitar descuento ir a Configuración > Configurar empresa y sistema">
              <i class="fa fa-info-circle"></i>
            </span>
            <div class="form-group">
