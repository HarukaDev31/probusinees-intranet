...
<div class="content-wrapper">
  ...
  <section class="content" style="background: #eeeeee; margin-left: 0px; margin-right: 0px;">
    <div class="row">
      <?php
      $iImpuestoGratuitaInafectoRetiroBonificacionID = 0;
      $iImpuestoGratuitaInafectoRetiroBonificacionValor = 0;
      if(is_object($rowImpuestoGratuita)){
        $iImpuestoGratuitaInafectoRetiroBonificacionID = $rowImpuestoGratuita->ID_Impuesto_Cruce_Documento;
        $iImpuestoGratuitaInafectoRetiroBonificacionValor = $rowImpuestoGratuita->Ss_Impuesto;
      }
      ...
      <!-- regalo -->
      <input type="hidden" id="hidden-id_impuesto_gratuita_inafecto_bonificacion" value="<?php echo $iImpuestoGratuitaInafectoRetiroBonificacionID; ?>">
      <input type="hidden" id="hidden-valor_impuesto_gratuita_inafecto_bonificacion" value="<?php echo $iImpuestoGratuitaInafectoRetiroBonificacionValor; ?>">
      ...
      <div class="col-xs-12 col-sm-5">
        <div class="row" style="display:none; background: #fcfcfc !important; padding: 10px; margin-bottom: 15px; margin-right: 0px; border-radius: 0.3em;">
          ...
          <div class="col-xs-4">
            <div class="form-group">
              ...
              <input type="hidden" id="hidden-codigo_moneda_sunat" value="<?php echo $this->session->userdata['arrDataPersonal']['arrData']['Nu_Codigo_Moneda_Sunat']; ?>">
              <input type="hidden" id="hidden-nombre_moneda" value="<?php echo $this->session->userdata['arrDataPersonal']['arrData']['No_Moneda']; ?>">
            </div>
          </div>
          <?php } ?>
        </div>
        ...
        <div class="row" style="background: #transparent !important; padding: 0px; margin-bottom: 0px; margin-right: 0px; border-radius: 0.3em;">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="form-group">
              <label style="">Producto</label> 
              <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Buscar por Nombre / Código / SKU. Clic en CREAR para nuevos productos o servicios">
                <i class="fa fa-info-circle"></i>
              </span>
              &nbsp;&nbsp;&nbsp;
              <span>
                  <label class="cursor_style_1">
                    <input type="radio" name="radio-addLector" class="flat-red" id="radio-InactiveLector" value="0" checked> Manual
                  </label> 
                  <label class="cursor_style_1">
                    <input type="radio" name="radio-addLector" class="flat-red" id="radio-ActiveLector" value="1"> Lector <span class="hidden-sm">Código Barra</span>
                  </label>
              </span>
              ...
              <?php } ?>
				        <span class="clearable_item_pos">
                  <input type="text" id="txt-No_Producto" class="form-control autocompletar_lector_codigo_barra hotkey-limpiar_item hotkey-cancelar_venta clearable_item_pos" data-global-class_method="AutocompleteController/getAllProduct" data-global-table="producto" onkeyup="autocompleteItemsAlternativos(this.value);" placeholder="Buscar por Nombre / Código / SKU" value="" autocomplete="off">
                  <i class="clearable__clear_item_pos">&times;</i>
                </span>
                <?php if($bStatusOpcionProductoAdd==1) { ?>
          ...
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            ...
            <span style="cursor: pointer;" class="" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Para configurar, debemos de ingresar a la opción Ventas -> Reglas de Venta -> Lista de Precios">
              <i class="fa fa-info-circle"></i>
            </span>
            <div class="form-group">
        ...
        <div class="row" <?php echo $sCssDisplay; ?>>
          <div class="col-xs-12 div-items_alternativos" style="height: 175px; overflow-y: auto;"><!-- 275 -->
            <table id="table-items_alternativos" class="table table-striped">
              <thead>
                <tr>
                  <th colspan="3" style="padding-top: 5px; padding-bottom: 5px;">Productos Alternativos</th>
                </tr>
              </thead>
              <tbody>
              </tbody>
        ...
        <?php
        $sCssDisplay='style="display:none"';
        if ( $this->empresa->Nu_Tipo_Rubro_Empresa==6 ){//6 = Ropa moda o calzado
          $sCssDisplay='';
        }?>
        <div class="row" <?php echo $sCssDisplay; ?>>
          <label style="padding-left: 15px;">Variante</label>
          <div class="col-xs-12 div-items_variante" style="height: 175px; overflow-y: auto;"><!-- 275 -->
            <table id="table-items_variante" class="table table-striped">
              <tbody>
              </tbody>
            </table>
          </div>
      ...
      <div class="col-xs-12 col-sm-7 sidenav" style="background: #fcfcfc !important; padding: 10px; margin-bottom: 15px; border-radius: 0.3em;">
        <div class="row">
            ...
            <div class="form-group">
              <select id="cbo-tipo_documento" name="tipo_documento" class="form-control hotkey-cobrar_cliente" style="width: 100%;padding: 3px;">
                <?php if($this->empresa->Nu_Tipo_Proveedor_FE != 3) { ?>
                  <option value="4" data-nu_cantidad_caracteres="8" data-codigo_tipo_documento_sunat="03" title="Puedes registrar cliente con DNI / Nombres" alt="Puedes registrar cliente con DNI / Nombres">Boleta</option>
                  <option value="3" data-nu_cantidad_caracteres="11" data-codigo_tipo_documento_sunat="01">Factura</option>
                <?php } ?>
                <option value="2" data-nu_cantidad_caracteres="15" data-codigo_tipo_documento_sunat="00" title="Son notas de venta interna y estas no son enviadas a SUNAT. Puedes registrar nota de venta ingresando solo Nombres del Cliente">Nota Venta</option>
              </select>
              <span class="help-block" id="error"></span>
            </div>
          </div>
          ...
          <div class="col-xs-6 col-sm-5 col-md-3 div-nuevo_cliente">
            ...
            <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Si ya existe cliente, busca por DNI / RUC / OTROS o Nombre, si no existe, se guardará y en la siguiente venta se podrá buscar">
              <i class="fa fa-info-circle"></i>
            </span>
            <div class="form-group">
              <input type="hidden" id="txt-Obtener_Lista_Precio" class="form-control">
              ...
              <input type="text" id="txt-ACodigo" name="Nu_Documento_Identidad" class="form-control autocompletar input-Mayuscula input-codigo_barra hotkey-cancelar_venta hotkey-cobrar_cliente hotkey-focus_item" onkeyup="api_sunat_reniec(this.value);" data-global-class_method="AutocompleteController/getAllClient" data-global-table="entidad" placeholder="Buscar / opcional" title="Si existe cliente ingresar Nombre / # Doc. Ident." maxlength="8" autocomplete="off">
              <span class="help-block" id="error"></span>
            </div>
          </div>

          <div class="col-xs-6 col-sm-6 col-md-5 div-nuevo_cliente">
            <label id="label-No_Entidad">Nombre <span class="hidden-xs">y Apellidos</span></label><span id="span-no_nombres_cargando"></span>
            <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Para buscar un cliente registrado, deben de escribir en el campo DNI / RUC / OTROS">
              <i class="fa fa-info-circle"></i>
            </span>
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" id="txt-ANombre" name="No_Entidad" class="form-control hotkey-cobrar_cliente hotkey-cancelar_venta hotkey-limpiar_item hotkey-focus_item" autocomplete="off" placeholder="opcional">
                <span class="help-block" id="error"></span>
                <div class="input-group-btn">
          ...
          <div class="col-xs-4 col-sm-6 col-md-6 col-lg-7"><!--div-nuevo_cliente-->
            <div class="form-group">
              ...
              <span style="cursor: pointer;" id="span_correo" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Si ingresas el email del cliente, se enviará el PDF y XML del comprobante electrónico. También quedará registrado para la próxima venta">
                <i class="fa fa-info-circle"></i>
              </span>
          ...
          <div class="col-xs-4 col-sm-7 col-md-3 col-lg-3 div-nuevo_cliente">
            <div class="form-group">
              <label>Celular</label>
              <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Se mostrará impreso en el ticket cuando la Recepción sea Delivery">
                <i class="fa fa-info-circle"></i>
              </span>
        ...
        <div class="row">
          <div class="col-xs-12 div-lista_compra_items" style="height: 240px; overflow-y: auto;"><!-- 317px 350px -->
        ...
        <div class="row" style="margin-top: 2%;">
          ...
          <div class="col-xs-4 col-md-3 div-fecha_entrega">
          ...
          <div class="col-xs-4 col-md-3">
            <label>Dscto.</label>
            <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Para desactivar / activar descuento ir a Configuración > Configurar empresa y sistema">
              <i class="fa fa-info-circle"></i>
            </span>
            <div class="form-group">
          ...
          <div class="col-xs-4 col-md-3">
            ...
            <span class="hidden-xs" style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Para habilitar descuento ir a Configuración > Configurar empresa y sistema">
              <i class="fa fa-info-circle"></i>
            </span>
            <div class="form-group">
            ...
            <div class="form-group">
              <button type="button" id="btn-pagar" class="btn btn-primary btn-lg btn-block">
                ...
                <div class="col-xs-5 text-right">
                  ...
                  <input type="hidden" class="hidden-gratuita" value="0.00">
                  <input type="hidden" class="hidden-gratuita_regalo_set_x_usuario" value="0.00">
        ...
        <!-- Atajos de teclado -->
        <div class="row">
          <div class="col-xs-4 col-sm-6 col-md-6 col-lg-3 hidden-xs">
          ...
          <div class="col-xs-4 col-sm-6 col-md-6 col-lg-3">
            <button type="button" id="btn-cancelar_venta" class="btn btn-link btn-lg btn-block">Cancelar <span class="hidden-xs">Venta</span></button>
          </div>
          <div class="col-xs-4 col-sm-6 col-md-6 col-lg-3">
            <button type="button" id="btn-add_nota_global" class="btn btn-link btn-lg btn-block">Adicionales</button>
          </div>
          <div class="col-xs-4 col-sm-6 col-md-6 col-lg-3">
            <button type="button" id="btn-guias_remision_pos" class="btn btn-link btn-lg btn-block">Guía(s)</button>
          </div>
        </div>
        <!-- ./ Atajos de teclado -->
      </div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="col-xs-7 col-sm-8 col-md-5 col-lg-4">
              <div class="form-group">
            ...
            <div class="col-xs-5 col-sm-4 col-md-2 col-lg-2">
              <label>PDF</label>
              <div class="form-group">
                <select id="cbo-formato_pdf" class="form-control required" style="width: 100%;"></select>
                <span class="help-block" id="error"></span>
              </div>
            </div>
            ...
            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
              ...
              <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Solo se usará si el servicio esta afecto a detracción">
                <i class="fa fa-info-circle"></i>
              </span>
              <div class="form-group">
                <label style="cursor: pointer;">
            ...
            <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 div-detraccion">
            ...
            <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 <?php //echo ($this->empresa->Nu_Tipo_Proveedor_FE == 2 ? '' : 'hidden'); ?>">
              <label>Retención</label>
              <div class="form-group">
                <label style="cursor: pointer;">
                  <input type="radio" name="radio-addRetencion" class="flat-red" id="radio-InactiveRetencion" value="0" checked> No
                </label>
                <label style="cursor: pointer;">
                  &nbsp;<input type="radio" name="radio-addRetencion" class="flat-red" id="radio-ActiveRetencion" value="1"> Si
                </label>
              </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6">
              <label>O/C / Servicio</label> (opcional)
              <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
              ...
              <div class="input-group date" style="width: 100%;">
                <input type="text" id="txt-Fe_Lote_Vencimiento" name="Fe_Lote_Vencimiento" class="form-control input-datepicker-today-to-more required" style="width: 100%;" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
              </div>
            </div>
          </div>
          <div class="modal-footer">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header" style="padding-bottom: 0px;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="text-center">Crear Producto o Servicio <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Para ver tus ítems ir a Compras y Productos > Reglas de Productos > Productos">
              <i class="fa fa-info-circle"></i>
            </span></h4>
          </div>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-xs-3 col-sm-2">
                ...
                <div class="form-group">
                  <input type="text" inputmode="decimal" id="txt-modal-precioItem" class="form-control required input-decimal" maxlength="13" autocomplete="off">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
              ...
              <div class="col-xs-3 col-sm-2">
                <label>Costo</label>
                <div class="form-group">
                  <input type="text" inputmode="decimal" id="txt-modal-costoItem" class="form-control required input-decimal" maxlength="13" autocomplete="off">
                  <span class="help-block" id="error"></span>
                </div>
              </div>
              ...
              <div class="col-xs-6">
                <label>Unidad <span class="hidden-xs">Medida</span></label>
              ...
              <div class="col-xs-6">
                ...
                <span style="cursor: pointer;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Para crear ir a Compras y Productos > Reglas de Productos >  Categoría">
                  <i class="fa fa-info-circle"></i>
                </span><a class="btn btn-link" target="_blank" style="padding:0px; color: #7b7b7b" href="<?php echo base_url() . 'Logistica/ReglasLogistica/CategoriaController/listarCategorias'; ?>">[Crear]</a>
                <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                  ...
                  <select id="cbo-Departamentos" name="ID_Departamento" class="form-control select2 cbo-Departamentos" style="width: 100%;"></select>
                  <span class="help-block" id="error"></span>
                </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                  ...
                  <select id="cbo-Provincias" name="ID_Provincia" class="form-control select2 cbo-Provincias" style="width: 100%;"></select>
                  <span class="help-block" id="error"></span>
                </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                  ...
                  <select id="cbo-Distritos" name="ID_Distrito" class="form-control select2 cbo-Distritos" style="width: 100%;"></select>
                  <span class="help-block" id="error"></span>
                </div>
              </div>
            </div>
    ...
    echo form_open('', $attributes);
    ?>
    <!-- Forma Pago POS Modal gratuita o regalo -->
        ...
        <div class="modal-content">
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12" id="div-regalo">
                <div class="alert alert-success alert-dismissible" style="padding: 5px; padding-bottom: 0px !important; margin-bottom: 8px;">
                  TOTAL IMPORTE REGALO <b><label id="label-regalo-total_importe">0.00</label></b><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                </div>
              </div>
              ...
              <div class="col-xs-6 col-sm-3 div-modal_datos_tarjeta_credito">
                <label id="label-tc_o_banco_credito">Tarjeta</label>
                <div class="form-group">
