...
function agregarEmpresa(){
  ...
  $('[name="ETxt_Direccion_Empresa"]').val('');
...
3 = Sin facturacion electronica*/
  ...
  if (Nu_Tipo_Proveedor_FE == 2 ) {
    $("#txt-url_fe_automatico").val('https://laesystems.com/librerias/SunatFacturador/cpe');
