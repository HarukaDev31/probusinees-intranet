...
$(function () {
    ...
    if ( $( '#cbo-FiltroMonedas' ).val() == '' ) {
      ...
      $.ajax({
        ...
        success: function(response){
          url = '';
          if (response.success){
            url = base_url + 'Configuracion/TasaCambioController/save_exchange_rate';
  ...
  url = base_url + 'Configuracion/TasaCambioController/ajax_list';
...
function verTasaCambio(ID){
  ...
  url = base_url + 'Configuracion/TasaCambioController/ajax_edit/' + ID;
  $.ajax({
    url : url,
    type: "GET",
    dataType: "JSON",
...
function form_TasaCambio(){
  if (accion_tasa_cambio == 'add_tasa_cambio' || accion_tasa_cambio == 'upd_tasa_cambio') {
    ...
    url = base_url + 'Configuracion/TasaCambioController/crudTasaCambio';
  	$.ajax({
      type		  : 'POST',
      dataType	: 'JSON',
  		url		    : url,
...
function _eliminarTasaCambio($modal_delete, ID){
  ...
  url = base_url + 'Configuracion/TasaCambioController/eliminarTasaCambio/' + ID;
  $.ajax({
    url       : url,
    type      : "GET",
    dataType  : "JSON",
