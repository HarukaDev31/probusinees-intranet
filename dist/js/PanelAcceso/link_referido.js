...
$(function () {
  ...
  $('.select2').select2();
  url = base_url + 'PanelAcceso/LinkReferidoController/ajax_list';
...
function verUsuario(ID_Usuario){
  ...
  url = base_url + 'PanelAcceso/LinkReferidoController/ajax_edit/' + ID_Usuario;
  $.ajax({
    url : url,
    type: "GET",
    dataType: "JSON",
...
function form_Usuario(){
  if ( accion_usuario=='add_usuario' || accion_usuario=='upd_usuario' ) {
    if ( $( '#cbo-organizacion' ).val() == 0 ){
      ...
      url = base_url + 'PanelAcceso/LinkReferidoController/crudUsuario';
    	$.ajax({
        type		  : 'POST',
        dataType	: 'JSON',
    		url		    : url,
...
function _eliminarUsuario($modal_delete, ID){
  ...
  url = base_url + 'PanelAcceso/LinkReferidoController/eliminarUsuario/' + ID;
  $.ajax({
    url       : url,
    type      : "GET",
    dataType  : "JSON",
