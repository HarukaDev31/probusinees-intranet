...
$(function () {
  	...
  	$( '.autocompletar_lector_codigo_barra' ).autoComplete({
		...
		onSelect: function(e, term, item){
			...
			arrItemVentaTemporal={
				...
				No_Laboratorio: item.data('no_laboratorio'),
			}
			...
			if (arrResponse.sStatus == 'success') {
				...
				$.post( url, arrParams, function( arrResponseComposicion ){
					if ( arrResponseComposicion.sStatus == 'success' || arrResponseComposicion.sStatus == 'warning' ) {
						var Txt_Composicion = '';
						if ( arrData.Txt_Composicion != null && arrData.Txt_Composicion.length > 0 ) {
						...
						sHtmlTableInfoItem +=
						'<div class="col-xs-12 col-sm-' + iColSm +'"><table id="modal-table-info_item" class="table table-hover">'+
							'<tbody>'+
								'<tr>'+
									'<td class="text-left" style="width: 25%"><b> Afectación Tributaria</b></td>'+
								...
								'<tr>'+
									...
									'<td class="text-left" style="width: 75%">' + Txt_Composicion + '</td>'+
								'</tr>'+
								'<tr>'+
								...
								'</tr>' +
								'<tr>' +
									'<td class="text-left" style="width: 25%"><b>Sub Categoría</b></td>' +
									'<td class="text-left" style="width: 75%">' + arrData.No_Sub_Familia + '</td>' +
								'</tr>' +
								'<tr>'+
	...
	$( '#table-items_alternativos tbody' ).on('click', '#btn-agregar_item_venta_temporal', function(){
		arrItemVentaTemporal={
			...
			No_Laboratorio: $(this).data('no_laboratorio'),
		}
		agregarItemVentaTemporal(arrItemVentaTemporal);
	})
	// ./ Button agregar items alternativos a venta temporal
	...
	$.post( base_url + 'AutocompleteController/getAllProductClic', sendData, function( response ){
		if ( response.length > 0 ) {
			...
			arrItemVentaTemporal={
				...
				No_Laboratorio: response.No_Laboratorio,
			}
			agregarItemVentaTemporal(arrItemVentaTemporal);
		...
		if (iValidarStockGlobal == 1 && ($('#txt-nu_tipo_item').val() == 1 || arrParams.iTipoProducto == 1) && (parseFloat(arrParams.qItem) <= 0.000000 || arrParams.qItem == null) ) {
			...
			if (isExistElementProductoPOS(arrParams.iIdItem)) {//Si existe el item, sumamos
				...
				"<tr id='tr_detalle_producto_pos" + arrParams.iIdItem + "' style='background-color: white !important;'>"
					...
					+"<td style='width:35%' class='text-left td-sNombreItem' title='Nombre item'>" + (arrParams.sCodigoInterno !== null && arrParams.sCodigoInterno != '' ? '[' + arrParams.sCodigoInterno + '] ' : '') + arrParams.sNombreItem + (arrParams.No_Laboratorio !== null && arrParams.No_Laboratorio != '' ? ' [' + arrParams.No_Laboratorio + '] ' : '') + "</td>"
				...
				if (iDataCompuestoLength > 0) {
					...
					if (bStatusStock) {
						...
						if (isExistElementProductoPOS(arrParams.iIdItem)) {//Si existe el item, sumamos
							...
							"<tr id='tr_detalle_producto_pos" + arrParams.iIdItem + "' style='background-color: white !important;'>"
								+"<td style='display:none;' class='text-left td-iIdItem'>" + arrParams.iIdItem + "</td>"
								+"<td style='width: 15%' class='text-right'><input type='text' id=" + arrParams.iIdItem + " class='txt-Qt_Producto_Class_Unico pos-input hotkey-limpiar_item hotkey-cancelar_venta hotkey-focus_item hotkey-cobrar_cliente txt-Qt_Producto form-control input-decimal input-qItem' " + (arrParams.iTipoProducto == 1 ? 'onkeyup=validateStockNow(event);' : '') + " value='1' data-id_item=" + arrParams.iIdItem + " data-ss_icbper_item='0.00' data-ss_icbper='" + arrParams.Ss_Icbper_item + "' data-id_impuesto_icbper='" + arrParams.iIdImpuestoIcbper + "' data-id_impuesto_cruce_documento='" + arrParams.iIdImpuestoCruceDocumento + "' data-nu_tipo_impuesto='" + arrParams.iTipoImpuesto + "' data-ss_impuesto='" + arrParams.fImpuesto + "' autocomplete='off' title='cantidad'></td>"
								+"<td style='width:35%' class='text-left td-sNombreItem' title='Nombre item'>" + (arrParams.sCodigoInterno !== null && arrParams.sCodigoInterno != '' ? '[' + arrParams.sCodigoInterno + '] ' : '') + arrParams.sNombreItem + (arrParams.No_Laboratorio !== null && arrParams.No_Laboratorio != '' ? ' [' + arrParams.No_Laboratorio + '] ' : '') + "</td>"
								+"<td style='width: 15%; " + sCssDisplayPrecio + "' class='text-right'><input type='text' class='pos-input hotkey-limpiar_item hotkey-cancelar_venta hotkey-focus_item hotkey-cobrar_cliente txt-Qt_Producto form-control input-decimal input-fPrecioItem' value='" + $fPrecioItem + "' data-id_item=" + arrParams.iIdItem + " data-id_impuesto_icbper='" + arrParams.iIdImpuestoIcbper + "' data-id_impuesto_cruce_documento='" + arrParams.iIdImpuestoCruceDocumento + "' data-nu_tipo_impuesto='" + arrParams.iTipoImpuesto + "' data-ss_impuesto='" + arrParams.fImpuesto + "' autocomplete='off' title='precio'></td>"
								+"<td style='width: 15%; " + sCssDisplayDsctoPV + "' class='text-right'><input type='text' class='pos-input hotkey-limpiar_item hotkey-cancelar_venta hotkey-focus_item hotkey-cobrar_cliente form-control input-decimal input-fDescuentoItem' autocomplete='off' placeholder='Dscto.' title='Descuento (opcional)'></td>"
								+"<td style='width: 15%' class='text-right td-Ss_Total_Producto' title='total'>" + $fPrecioItem + "</td>"
								+"<td style='display:none; width: 39%' class='text-right td-sNotaItem' data-estado='mostrar' data-id_item=" + arrParams.iIdItem + " id='td-sNotaItem" + arrParams.iIdItem + "'>"
								+"<textarea class='pos-input form-control input-sNotaItem hotkey-cobrar_cliente hotkey-cancelar_venta hotkey-limpiar_item hotkey-focus_item' placeholder='' maxlength='250' autocomplete='off'></textarea></td>"
								+"</td>"
...
function agregarItemAlternativos(arrResponse){
	...
	if ( arrResponse.sStatus=='success' ) {
		var l = arrResponse.arrData.length, fStock = 0, $fPrecioItem = 0, sNombreUnidadMedida = '', sNombreMarca = '', sNombreLaboratorio = '';
		for (var x=0; x < l; x++){
			...
			sNombreUnidadMedida = (arrData[x].No_Unidad_Medida !== null ? arrData[x].No_Unidad_Medida : '');
			sNombreMarca = (arrData[x].No_Marca !== null ? arrData[x].No_Marca : '');
			sNombreLaboratorio = (arrData[x].No_Laboratorio !== null ? arrData[x].No_Laboratorio : '');

			tr_body_table_alternativo += 
			"<tr id='tr_item_alternativo" + arrData[x].ID + "'>"
				+"<td class='text-left' style='width: 5%'><button type='button' id='btn-agregar_item_venta_temporal' class='btn btn-sm btn-link' alt='Agregar' title='Agregar' data-id='" + arrData[x].ID + "' data-ss_icbper_item='0.00' data-no_laboratorio='" + arrData[x].No_Laboratorio + "' data-ss_icbper='" + arrData[x].Ss_Icbper_item + "' data-id_impuesto_icbper='" + arrData[x].ID_Impuesto_Icbper + "' data-no_codigo_interno='" + arrData[x].No_Codigo_Interno + "' data-nombre='" + arrData[x].Nombre + "' data-qt_producto='" + arrData[x].Qt_Producto + "' data-precio='" + $fPrecioItem + "' data-id_impuesto_cruce_documento='" + arrData[x].ID_Impuesto_Cruce_Documento + "' data-nu_tipo_impuesto='" + arrData[x].Nu_Tipo_Impuesto + "' data-ss_impuesto='" + arrData[x].Ss_Impuesto + "'>Add</button></td>"
				+"<td style='display:none;' class='text-left'>" + arrData[x].iIdItem + "</td>"
				+"<td class='text-left' style='width: 35%' title='Nombre' alt='Nombre'>" + arrData[x].Nombre + "</td>"
				+"<td class='text-right td-fPrecioItem' style='width: 20%' title='Precio' alt='Precio'>" + parseFloat($fPrecioItem).toFixed(2) + "</td>"
				+"<td class='text-right' style='width: 10%' title='Stock' alt='Stock'>" + fStock.toFixed(2) + "</td>"
				+"<td class='text-left' style='width: 10%' title='Unidad de Medida' alt='Unidad de Medida'>" + sNombreUnidadMedida + "</td>"
				+"<td class='text-left' style='width: 10%' title='Marca' alt='Marca'>" + sNombreMarca + "</td>"
				+"<td class='text-left' style='width: 10%' title='Laboratorio' alt='Laboratorio'>" + sNombreLaboratorio + "</td>"
			+"</tr>";
		}
    } else {
		tr_body_table_alternativo += 
		"<tr>"
			+"<td colspan='7' class='text-center'>" + arrResponse.sMessage + "</td>"
		+"</tr>";
	}
...
function validarVentaPrevia(){
	...
	if ($('#cbo-almacen').val() == 0) {
		...
		$('#txt-ACodigo').closest('.form-group').find('.help-block').html('Solo se puede emitir Factura con RUC');
		$('#txt-ACodigo').closest('.form-group').removeClass('has-success').addClass('has-error');
...
function generarComprobante(){
	...
	var $url = base_url + 'PuntoVenta/POSFarmaciaController/agregarVentaPos';
	var $arrParamsPost = {
