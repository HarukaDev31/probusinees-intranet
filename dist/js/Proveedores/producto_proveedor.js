...
$(function () {
  ...
  $( '#cbo-Empresas' ).html('<option value="0" selected="selected">Cargando..</option>');
  $( '#cbo-filtro-proveedores' ).html('<option value="0" selected="selected">Cargando..</option>');
  $( '#cbo-filtro-almacenes' ).html('<option value="0" selected="selected">- TODOS -</option>');

  url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/ajax_list';
  table_producto = $('#table-Producto').DataTable({
    ...
    'ajax': {
      ...
      'data'      : function ( data ) {
        ...
        data.ID_Filtro_Proveedor = $('#cbo-filtro-proveedores').val(),
        data.ID_Filtro_Almacen = $('#cbo-filtro-almacenes').val(),
    ...
    'columnDefs': [{
      ...
      'className' : 'text-right',
      'targets'   : 'no_sort_right',
      'orderable' : false,
    },{
      'className' : 'text-left',
      'targets'   : 'no_sort_left',
      'orderable' : false,
    },],
    'lengthMenu': [[50, 100, 1000, -1], [50, 100, 500, 1000]],
  });
  ...
  $.post(url, function (response) {
    $('#cbo-Empresas').html('<option value="0" selected="selected">- TODOS -</option>');
  ...
  //FILTRO PROVEEDORES
  url = base_url + 'HelperDropshippingController/getProveedoresDropshipping';
  var selected = '';
  $.post(url, function (response) {
    $('#cbo-filtro-proveedores').html('<option value="0" selected="selected">- TODOS -</option>');
    for (var i = 0; i < response.length; i++) {
      $('#cbo-filtro-proveedores').append('<option value="' + response[i].ID_Empresa + '">' + response[i].No_Empresa + '</option>');
    }
  }, 'JSON');

  //FILTRO POR ALMACENES
	$( '#cbo-filtro-proveedores' ).change(function(){
    if ( $(this).val() > 0 ) {
      url = base_url + 'HelperDropshippingController/getProveedoresAlmacenesDropshipping';
      var arrParams = {iIdEmpresa : $( this ).val()};
      $.post( url, arrParams, function( response ){
        $( '#cbo-filtro-almacenes' ).html('<option value="0" selected="selected">- TODOS -</option>');
        for (var i = 0; i < response.length; i++)
          $( '#cbo-filtro-almacenes' ).append( '<option value="' + response[i].ID_Almacen + '">' + response[i].No_Almacen + '</option>' );
      }, 'JSON');
    }
  ...
  $('#cbo-filtro-almacenes').change(function () {
    table_producto.search($(this).val()).draw();
  });
  ...
  $('#btn-activar_producto_masivamente').click(function () {
    ...
    $('#btn-save-delete').off('click').click(function () {
      ...
      url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/updActivarMasivamenteProductos';
      var arrPost = {
...
Dropzone.prototype._default= function(e){
  ...
  url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/uploadMultiple';
...
function verProducto(ID, No_Imagen_Item, Nu_Version_Imagen){
  ...
  url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/ajax_edit/' + ID;
  $.ajax({
    url : url,
    type: "GET",
    dataType: "JSON",
    success: function(response){
      ...
      if($( '[name="Txt_Url_Video_Lae_Shop"]' ).val()) {
        $( '[name="Txt_Url_Video_Lae_Shop"]' ).addClass("requerido");
      }
      ...
      if (response.Nu_Activar_Precio_x_Mayor == 1) {
        ...
        url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/ajax_edit_precios_por_mayor/' + ID;
...
if (Dropzone.instances.length > 0) 
  ...
  Dropzone.prototype._remove= function(e){
    ...
    url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/removeFileImage';
    $.ajax({
      url : url,
      type: "POST",
      dataType: "JSON",
...
Dropzone.prototype._default= function(e){
    ...
    url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/DefaultImagen';
    // console.log(imagen);
  ...
  dropZoneGloblal = new Dropzone("#id-divDropzone", {
    ...
    init : function() {
      ...
      root.id_imagen = 0;
      //console.log(root);
      url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/get_image';
      $.ajax({
        url : url,
        type: "POST",
        dataType: "JSON",
...
function form_Producto(){
  if (accion_producto == 'add_producto' || accion_producto == 'upd_producto') {
    ...
    if ( $( '#cbo-TiposItem' ).val() != '2' && $( '#cbo-Impuestos' ).val() == '0'){
      ...
      url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/crudProducto';
      $.ajax({
        type      : 'POST',
        dataType  : 'JSON',
        url       : url,
...
function _eliminarProducto($modal_delete, ID_Empresa, ID, Nu_Codigo_Barra, Nu_Compuesto, sNombreImagenItem){
  ...
  url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/eliminarProducto/' + ID_Empresa + '/' + ID + '/' + Nu_Codigo_Barra + '/' + Nu_Compuesto + '/' + sNombreImagenItem;
  $.ajax({
    url       : url,
    type      : "GET",
    dataType  : "JSON",
...
function cambiarEstadoTienda(ID, Nu_Estado) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/cambiarEstadoTienda/' + ID + '/' + Nu_Estado;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
...
function cambiarEstadoDestacado(ID, Nu_Estado) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'Proveedores/ProductosProveedoresDropshippingController/cambiarEstadoDestacado/' + ID + '/' + Nu_Estado;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
