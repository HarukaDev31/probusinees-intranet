...
$(function () {
  ...
  url = base_url + 'Paginas/InicioController/ajax_list';
  ...
  /* slider mobile */
  url = base_url + 'Paginas/InicioController/ajax_list_slider_mobile';
  ...
  url = base_url + 'Paginas/InicioController/ajax_list_ofertas';
...
function agregarInicio(iTipoInicio){
  ...
  url = base_url + 'Paginas/InicioController/uploadOnly';
  var myDropzone = new Dropzone("#id-divDropzone", {
    ...
    removedfile: function(file){
      ...
      url = base_url + 'Paginas/InicioController/removeFileImage';
      $.ajax({
        url : url,
        type: "POST",
        dataType: "JSON",
...
function verInicio(ID, No_Imagen_Inicio_Slider, No_Imagen_Url_Inicio_Slider, Nu_Version_Imagen){
  ...
  url = base_url + 'Paginas/InicioController/ajax_edit/' + ID;
  $.ajax({
    url : url,
    type: "GET",
    dataType: "JSON",
  ...
  url = base_url + 'Paginas/InicioController/uploadOnly/' + ID;
  var myDropzone = new Dropzone("#id-divDropzone", {
    url: url,
    params: {
    ...
    init : function() {
      ...
      var me = this;
      url = base_url + 'Paginas/InicioController/get_image';
      var arrPost={
...
function form_Inicio(){
  if ( accion_familia=='add_familia' || accion_familia=='upd_familia' ) {
    ...
    url = base_url + 'Paginas/InicioController/crudInicio';
  	$.ajax({
      type		  : 'POST',
      dataType	: 'JSON',
  		url		    : url,
...
function _eliminarInicio($modal_delete, ID){
  ...
  url = base_url + 'Paginas/InicioController/eliminarInicio/' + ID;
  $.ajax({
    url       : url,
    type      : "GET",
    dataType  : "JSON",
