...
$(function () {
  ...
  $('#btn-save_delivery_importe').off('click').click(function () {
    ...
    */
      ...
      url = base_url + 'CoordinadoController/actualizarPrecioDelivery';
      $.ajax({
        type		  : 'POST',
        dataType	: 'JSON',
        url		    : url,
  ...
  $('#btn-save_nota_pedido').off('click').click(function () {
    if($('[name="Txt_Glosa_Pedido"]').val().length==0){
      ...
      url = base_url + 'CoordinadoController/actualizarNotaPedido';
      $.ajax({
        type		  : 'POST',
        dataType	: 'JSON',
        url		    : url,
  ...
  $('#btn-save_asignar_delivery').off('click').click(function () {
    if($('[name="ID_Usuario_Asignar_Delivery"]').val().length==0){
      ...
      url = base_url + 'CoordinadoController/asignarUsuarioDelivery';
      $.ajax({
        type		  : 'POST',
        dataType	: 'JSON',
        url		    : url,
  ...
  $('#btn-save_delivery_saldo_a_favor').off('click').click(function () {
    ...
    */
      ...
      url = base_url + 'CoordinadoController/actualizarPrecioDeliverySaldoAFavor';
      $.ajax({
        type		  : 'POST',
        dataType	: 'JSON',
        url		    : url,
  ...
  $( '.btn-generar_ventas_detalladas_generales' ).click(function(){
    ...
    if ($(this).data('type') == 'html') {
      ...
      url = base_url + 'CoordinadoController/sendReportePDF/' + Fe_Inicio + '/' + Fe_Fin + '/' + ID_Tipo_Documento + '/' + ID_Pedido_Cabecera + '/' + Nu_Estado_Pedido + '/' + iIdCliente + '/' + encodeURIComponent(sNombreCliente) + '/' + ID_Filtro_Empresa + '/' + Nu_Estado_Pedido_Empresa + '/' + encodeURIComponent(sNombreCiudad);
      ...
      url = base_url + 'CoordinadoController/sendReporteEXCEL/' + Fe_Inicio + '/' + Fe_Fin + '/' + ID_Tipo_Documento + '/' + ID_Pedido_Cabecera + '/' + Nu_Estado_Pedido + '/' + iIdCliente + '/' + encodeURIComponent(sNombreCliente) + '/' + ID_Filtro_Empresa + '/' + Nu_Estado_Pedido_Empresa + '/' + encodeURIComponent(sNombreCiudad) + '/' + ID_Pais;
      window.open(url,'_blank');
  ...
  $('#btn-modal-generar_venta-send').click(function () {
    if (parseFloat($('[name="fTotalDocumento"]').val()) < 0.10) {
      ...
      url = base_url + 'CoordinadoController/generarVenta';
      $.ajax({
        type: 'POST',
        dataType: 'JSON',
        url: url,
...
function getReporteHTML() {
  ...
  url = base_url + 'CoordinadoController/sendReporte';
...
function verPedido(iIdPedido){
  ...
  url = base_url + 'CoordinadoController/verPedido/' + iIdPedido;
...
function eliminarPedido(ID) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'CoordinadoController/eliminarPedido/' + ID;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
...
function generarVenta(ID_Pedido_Cabecera){
  ...
  $('#modal-loader').modal('show');
  url = base_url + 'CoordinadoController/verPedido/' + ID_Pedido_Cabecera;
  $.getJSON(url, function (response) {
    if (response.sStatus == 'success') {
...
function form_AgregarPedido(){
  ...
  if ( $( '#txt-EID_Pedido_Cabecera' ).val().length==0 && arrDetallePedido.length === 0){
    ...
    url = base_url + 'CoordinadoController/crudPedido';
    $.ajax({
      type		  : 'POST',
      dataType	: 'JSON',
      url		    : url,
...
function editarPedido(ID){
  ...
  url = base_url + 'CoordinadoController/ajax_edit/' + ID;
  $.ajax({
    url : url,
    type: "GET",
    dataType: "JSON",
...
function cambiarEstadoPedidoEmpresa(ID, Nu_Estado) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'CoordinadoController/cambiarEstadoPedidoEmpresa/' + ID + '/' + Nu_Estado;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
...
function generarGuia99(ID){
  ...
  $('.modal-title-message-delete').text('¿Generar Guia de 99?');
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'CoordinadoController/generarGuia99/' + ID;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
