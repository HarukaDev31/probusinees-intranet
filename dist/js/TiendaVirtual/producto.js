...
$(function () {
  ...
  url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/ajax_list';
  ...
  $('#btn-activar_producto_masivamente').click(function () {
    ...
    $('#btn-save-delete').off('click').click(function () {
      ...
      url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/updActivarMasivamenteProductos';
      var arrPost = {
...
Dropzone.prototype._default= function(e){
  ...
  url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/uploadMultiple';
...
function verProducto(ID, No_Imagen_Item, Nu_Version_Imagen){
  ...
  url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/ajax_edit/' + ID;
  $.ajax({
    url : url,
    type: "GET",
    dataType: "JSON",
    success: function(response){
      ...
      if(response.Nu_Estado_Variantes == 1) {
        ...
        url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/getVariantes/' + ID;
        $.ajax({
          url : url,
          type: "GET",
          dataType: "JSON",
...
if (Dropzone.instances.length > 0) 
  ...
  Dropzone.prototype._remove= function(e){
    ...
    url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/removeFileImage';
    $.ajax({
      url : url,
      type: "POST",
      dataType: "JSON",
...
Dropzone.prototype._default= function(e){
    ...
    url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/DefaultImagen';
    // console.log(imagen);
  ...
  dropZoneGloblal = new Dropzone("#id-divDropzone", {
    ...
    init : function() {
      ...
      root.id_imagen = 0;
      //console.log(root);
      url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/get_image';
      $.ajax({
        url : url,
        type: "POST",
        dataType: "JSON",
...
function form_Producto(){
  if (accion_producto == 'add_producto' || accion_producto == 'upd_producto') {
    ...
    if ( $( '#cbo-TiposItem' ).val() != '2' && $( '#cbo-Impuestos' ).val() == '0'){
      ...
      url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/crudProducto';
      $.ajax({
        type      : 'POST',
        dataType  : 'JSON',
        url       : url,
...
function _eliminarProducto($modal_delete, ID_Empresa, ID, Nu_Codigo_Barra, Nu_Compuesto, sNombreImagenItem){
  ...
  url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/eliminarProducto/' + ID_Empresa + '/' + ID + '/' + Nu_Codigo_Barra + '/' + Nu_Compuesto + '/' + sNombreImagenItem;
  $.ajax({
    url       : url,
    type      : "GET",
    dataType  : "JSON",
...
function cambiarEstadoTienda(ID, Nu_Estado) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/cambiarEstadoTienda/' + ID + '/' + Nu_Estado;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
...
function cambiarEstadoDestacado(ID, Nu_Estado) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/cambiarEstadoDestacado/' + ID + '/' + Nu_Estado;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
...
function getProductosRelacionados() {
  ...
  if( IDProductoPrincipal > 0) {
    $('.table-productos_relacionados_manual tbody').html('');
    $( '#modal-loader' ).modal('show');
    url = base_url + 'TiendaVirtual/ItemsTiendaVirtualController/getProductosRelacionados/' + IDProductoPrincipal;
    $.ajax({
      url : url,
      type: "GET",
      dataType: "JSON",
