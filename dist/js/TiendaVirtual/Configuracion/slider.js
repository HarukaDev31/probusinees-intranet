...
$(function () {
  ...
  url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/ajax_list';
  ...
  /* slider mobile */
  url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/ajax_list_slider_mobile';
  ...
  url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/ajax_list_ofertas';
...
function agregarInicio(iTipoInicio){
  ...
  url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/uploadOnly';
  var myDropzone = new Dropzone("#id-divDropzone", {
    ...
    removedfile: function(file){
      ...
      url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/removeFileImage';
      $.ajax({
        url: url,
        type: "POST",
        dataType: "JSON",
...
function verInicio(ID, No_Imagen_Inicio_Slider, No_Imagen_Url_Inicio_Slider, Nu_Version_Imagen){
  ...
  url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/ajax_edit/' + ID;
  $.ajax({
    url : url,
    type: "GET",
    dataType: "JSON",
  ...
  url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/uploadOnly/' + ID;
  var myDropzone = new Dropzone("#id-divDropzone", {
    url: url,
    params: {
    ...
    init: function () {
      ...
      if (No_Imagen_Url_Inicio_Slider.length > 0 && No_Imagen_Url_Inicio_Slider != '' && No_Imagen_Url_Inicio_Slider !== undefined) {
        var me = this;
        url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/get_image';
        var arrPost = {
...
function form_Inicio(){
  if ( accion_familia=='add_familia' || accion_familia=='upd_familia' ) {
    ...
    url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/crudInicio';
  	$.ajax({
      type		  : 'POST',
      dataType	: 'JSON',
  		url		    : url,
...
function _eliminarInicio($modal_delete, ID){
  ...
  url = base_url + 'TiendaVirtual/Configuracion/SliderTiendaVirtualController/eliminarInicio/' + ID;
  $.ajax({
    url       : url,
    type      : "GET",
    dataType  : "JSON",
