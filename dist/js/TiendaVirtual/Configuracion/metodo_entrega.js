...
$(function () {
  ...
  url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/ajax_list';
  ...
  url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/ajax_list_distrito';
  ...
  $('#btn-modificar_precio_estandar_delivery').click(function () {
    if($('#txt-Ss_Precio_Estandar_Delivery').val().length==0){
      ...
      url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/updPrecioEstandarDelivery';
      var arrPost = {
...
function verMetodoEntrega(ID) {
  ...
  url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/ajax_edit/' + ID;
  $.ajax({
    url: url,
    type: "GET",
    dataType: "JSON",
...
function form_MedioPago() {
  ...
  url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/crudMedioPago';
  $.ajax({
    type: 'POST',
    dataType: 'JSON',
    url: url,
...
function verDistrito(ID) {
  ...
  url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/ajax_edit_distrito/' + ID;
  $.ajax({
    url: url,
    type: "GET",
    dataType: "JSON",
...
function form_Distrito() {
  if (accion_distrito == 'add_distrito' || accion_distrito == 'upd_distrito') {
    ...
    url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/crudDistrito';
    $.ajax({
      type: 'POST',
      dataType: 'JSON',
      url: url,
...
function form_PromoDelivery(){
  ...
  url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/crudPromoDelivery';
  $.ajax({
    type		    : 'POST',
    dataType	  : 'JSON',
    url		      : url,
...
function getPromoDelivery() {
  url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/ajax_promoDelivery';
  $.ajax({
    type		    : 'GET',
    dataType	  : 'JSON',
    url		      : url,
...
function cambiarEstadoTienda(ID, Nu_Estado) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'TiendaVirtual/Configuracion/MetodosEntregaTiendaVirtualController/cambiarEstadoTienda/' + ID + '/' + Nu_Estado;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
