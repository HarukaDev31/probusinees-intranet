...
$(function () {
  ...
  url = base_url + 'Dropshipping/ProductosDropshippingController/ajax_list';
  ...
  $('#btn-activar_producto_masivamente').click(function () {
    ...
    $('#btn-save-delete').off('click').click(function () {
      ...
      url = base_url + 'Dropshipping/ProductosDropshippingController/updActivarMasivamenteProductos';
      var arrPost = {
...
Dropzone.prototype._default= function(e){
  ...
  url = base_url + 'Dropshipping/ProductosDropshippingController/uploadMultiple';
...
function verProducto(ID, No_Imagen_Item, Nu_Version_Imagen){
  ...
  url = base_url + 'Dropshipping/ProductosDropshippingController/ajax_edit/' + ID;
  $.ajax({
    url : url,
    type: "GET",
    dataType: "JSON",
    success: function(response){
      ...
      if (response.Nu_Activar_Precio_x_Mayor == 1) {
        ...
        url = base_url + 'Dropshipping/ProductosDropshippingController/ajax_edit_precios_por_mayor/' + ID;
...
if (Dropzone.instances.length > 0) 
  ...
  Dropzone.prototype._remove= function(e){
    ...
    url = base_url + 'Dropshipping/ProductosDropshippingController/removeFileImage';
    $.ajax({
      url : url,
      type: "POST",
      dataType: "JSON",
...
Dropzone.prototype._default= function(e){
    ...
    url = base_url + 'Dropshipping/ProductosDropshippingController/DefaultImagen';
    // console.log(imagen);
  ...
  dropZoneGloblal = new Dropzone("#id-divDropzone", {
    ...
    init : function() {
      ...
      root.id_imagen = 0;
      //console.log(root);
      url = base_url + 'Dropshipping/ProductosDropshippingController/get_image';
      $.ajax({
        url : url,
        type: "POST",
        dataType: "JSON",
...
function form_Producto(){
  if (accion_producto == 'add_producto' || accion_producto == 'upd_producto') {
    ...
    if ( $( '#cbo-TiposItem' ).val() != '2' && $( '#cbo-Impuestos' ).val() == '0'){
      ...
      url = base_url + 'Dropshipping/ProductosDropshippingController/crudProducto';
      $.ajax({
        type      : 'POST',
        dataType  : 'JSON',
        url       : url,
...
function _eliminarProducto($modal_delete, ID_Empresa, ID, Nu_Codigo_Barra, Nu_Compuesto, sNombreImagenItem){
  ...
  url = base_url + 'Dropshipping/ProductosDropshippingController/eliminarProducto/' + ID_Empresa + '/' + ID + '/' + Nu_Codigo_Barra + '/' + Nu_Compuesto + '/' + sNombreImagenItem;
  $.ajax({
    url       : url,
    type      : "GET",
    dataType  : "JSON",
...
function cambiarEstadoTienda(ID, Nu_Estado) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'Dropshipping/ProductosDropshippingController/cambiarEstadoTienda/' + ID + '/' + Nu_Estado;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
...
function cambiarEstadoDestacado(ID, Nu_Estado) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'Dropshipping/ProductosDropshippingController/cambiarEstadoDestacado/' + ID + '/' + Nu_Estado;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
