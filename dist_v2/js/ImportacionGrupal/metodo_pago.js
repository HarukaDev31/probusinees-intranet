...
function verMedioPago(ID) {
  ...
  url = base_url + 'ImportacionGrupal/MetodoPagoGrupal/ajax_edit/' + ID;
  $.ajax({
    url: url,
    type: "GET",
    dataType: "JSON",
...
function form_MedioPago() {
  ...
  url = base_url + 'ImportacionGrupal/MetodoPagoGrupal/crudMedioPago';
  $.ajax({
    type: 'POST',
    dataType: 'JSON',
    url: url,
...
function eliminarMedioPago(ID) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'ImportacionGrupal/MetodoPagoGrupal/eliminarMedioPago/' + ID;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
...
function verMedioPago_cuentas_bancarias(ID) {
  ...
  url = base_url + 'ImportacionGrupal/MetodoPagoGrupal/ajax_edit_cuentas_bancarias/' + ID;
  $.ajax({
    url: url,
    type: "GET",
    dataType: "JSON",
...
function form_MedioPago_cuentas_bancarias() {
  ...
  url = base_url + 'ImportacionGrupal/MetodoPagoGrupal/crudMedioPago_cuentas_bancarias';
  $.ajax({
    type: 'POST',
    dataType: 'JSON',
    url: url,
...
function eliminarMedioPago_cuentas_bancarias(ID) {
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'ImportacionGrupal/MetodoPagoGrupal/eliminarMedioPago_cuentas_bancarias/' + ID;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
...
function activarMercadoPago(){
  ...
  $('#btn-save-delete').off('click').click(function () {
    ...
    url = base_url + 'ImportacionGrupal/MetodoPagoGrupal/activarMercadoPago';
    $.ajax({
      url: url,
      type: "POST",
      dataType: "JSON",
