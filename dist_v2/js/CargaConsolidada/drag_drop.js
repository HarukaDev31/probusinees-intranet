  class FileManager {
      ...
      renderPendingFiles(pendingFile) {
          ...
          this.data.pendingFiles.forEach(file => {
            const $fileItem = $('<div>', {
              class: 'file-item flex justify-between items-center p-2 mb-2 border border-gray-300 rounded bg-gray-50',
            ...
            const $progressCircle = $('<svg>', {
              ...
              $('<circle >', {
                class: 'circle-background transition-all ease-in-out',
                cx: 18,
                cy: 18,
                r: 15,
                stroke: 'red',
