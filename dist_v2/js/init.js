...
function initSetupSingleFileUpload(containerId, inputId, allowedFileTypes = [], selectInputId = '.upload-button', automaticUpload = false) {
  try {
    ...
    fileInput.addEventListener('change', (e) => {
      if (fileInput.files.length > 0) {
        ...
        const fileIcon = initGetIconByType(fileType || fileExtension);
...
function initGetIconByType(typeOrExtension) {
  const icons = {
    pdf: `
...
async function initConfigurarBuscador(tableId, searchInputId, infoContainerId) {
